...
<div class="i-wrap">
	...
	<form action="index.php?controller=pjInstaller&amp;action=pjActionStep5&amp;install=1" method="post" id="frmStep4" class="i-form">
		...
		<div class="t20">
			...
			<input type="button" tabindex="4" value="&laquo; Back" class="pj-button float_right" onclick="window.location='index.php?controller=pjInstaller&amp;action=pjActionStep3'" />
			<br class="clear_both" />
		</div>
	</form>
</div>