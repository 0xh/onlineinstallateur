...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(@$titles['PCY11'], @$bodies['PCY11']);
	?>
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjCountry&amp;action=pjActionUpdate" method="post" id="frmUpdateCountry" class="form pj-form">
		...
		<p>
			...
			<span class="inline_block">
				<input type="text" name="alpha_2" id="alpha_2" class="pj-form-field w50" value="<?php echo pjSanitize::html($tpl['arr']['alpha_2']); ?>" maxlength="2" />
			</span>
		</p>
		<p>
			<label class="title"><?php __('plugin_country_alpha_3'); ?>:</label>
			<span class="inline_block">
				<input type="text" name="alpha_3" id="alpha_3" class="pj-form-field w50" value="<?php echo pjSanitize::html($tpl['arr']['alpha_3']); ?>" maxlength="3" />
			</span>
		</p>
		<p>
