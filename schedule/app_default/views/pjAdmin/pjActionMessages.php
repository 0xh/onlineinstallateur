...
if (asApp !== undefined) {
	asApp = jQuery_1_8_2.extend(asApp, {
		locale: {
			button: <?php echo pjAppController::jsonEncode(array_merge(__('buttons', true), array('add' =>__('btnAdd', true, false), 'cancel' =>__('btnCancel', true, false)))); ?>
		}
	});
}