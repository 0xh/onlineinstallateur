...
if (isset($tpl['status']))
{
	...
	?>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminEmployees&amp;action=pjActionCreate" method="post" id="frmCreateEmployee" class="form pj-form" enctype="multipart/form-data" autocomplete="off">
		...
		<p style="position: relative">
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="email" id="email" class="pj-form-field required email w200" autocomplete="off" value="" />
			</span>
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="password" name="password" id="password" class="pj-form-field required w200" autocomplete="off" value="" />
			</span>
		</p>
		<p style="position: relative">
