...
INSERT INTO `multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`) VALUES
(NULL, @id, 'pjField', 1, 'title', 'Translate and change titles', 'plugin'),
(NULL, @id, 'pjField', 2, 'title', 'Translate and change titles', 'plugin'),
(NULL, @id, 'pjField', 3, 'title', 'Translate and change titles', 'plugin');
