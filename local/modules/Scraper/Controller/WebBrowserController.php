...
class WebBrowserController extends BaseAdminController
{
    ...
    public function test_product_info($searchBase, $searchQuerry, $requestType, $resultSelector, $resultAttributeName,
                                      $productSelector, $productAttributeName)
    {
...
//            }
    ...
    public function getPage($url, $fields = null, $typeRequest = "POST")
    {
        ...
        if ($statusCode != 200) {
            $this->setLogger()->error("Status code #: " . $statusCode . " link = " . $url);
        }
