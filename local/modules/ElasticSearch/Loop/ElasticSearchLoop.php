 ...
 */
class ElasticSearchLoop extends BaseI18nLoop implements PropelSearchLoopInterface, SearchLoopInterface
{
    ...
    private function associateValues($loopResultRow, $product, $defaultCategoryId)
    {
        ...
        $loopResultRow
            ...
            ->set("FAQ_COL2", $product->getVirtualColumn('i18n_FAQ_COL2'))
    ...
    $categoryArgument = $this->getCategory();
        ...
        /* manage translations */
        $this->configureI18nProcessing($search, ['TITLE', 'CHAPO', 'DESCRIPTION', 'POSTSCRIPTUM','FAQ','FAQ_COL2', 'META_TITLE', 'META_DESCRIPTION', 'META_KEYWORDS']);
