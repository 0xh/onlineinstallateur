...
class PageBuilderUpdateController extends AbstractSeoCrudController
{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            PageBuilderEvents::PAGE_BUILDER_CREATE,
            PageBuilderEvents::PAGE_BUILDER_UPDATE,
            PageBuilderEvents::PAGE_BUILDER_DELETE,
            null,
            PageBuilderEvents::RELATED_PRODUCT_UPDATE_POSITION,
            PageBuilderEvents::PAGE_BUILDER_UPDATE_SEO,
            'PageBuilder'
        );
    }
    ...
    protected function renderEditionTemplate()
    {
        $this->getParserContext()
            ->set(
                'page_builder_id',
                $this->getRequest()->get('pageBuilderId')
            );
    ...
    protected function createUpdatePositionEvent($positionChangeMode, $positionValue)
    {
        return new UpdatePositionEvent(
            ...
            $positionChangeMode,
            $positionValue,
            $this->getRequest()->get('page_builder_id', null)
        );
    }
