...
abstract class SelectionI18n implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Selection\\Model\\Map\\SelectionI18nTableMap';
    ...
    /**
     * Initializes internal state of Selection\Model\Base\SelectionI18n object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SelectionI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>SelectionI18n</code>, delegates to
     * <code>equals(SelectionI18n)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return SelectionI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SelectionI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[SelectionI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[SelectionI18nTableMap::TITLE] = true;
        }
    ...
    public function setChapo($v)
    {
        ...
        if ($this->chapo !== $v) {
            $this->chapo = $v;
            $this->modifiedColumns[SelectionI18nTableMap::CHAPO] = true;
        }
    ...
    public function setPostscriptum($v)
    {
        ...
        if ($this->postscriptum !== $v) {
            $this->postscriptum = $v;
            $this->modifiedColumns[SelectionI18nTableMap::POSTSCRIPTUM] = true;
        }
    ...
    public function setMetaTitle($v)
    {
        ...
        if ($this->meta_title !== $v) {
            $this->meta_title = $v;
            $this->modifiedColumns[SelectionI18nTableMap::META_TITLE] = true;
        }
    ...
    public function setMetaDescription($v)
    {
        ...
        if ($this->meta_description !== $v) {
            ...
            $this->modifiedColumns[SelectionI18nTableMap::META_DESCRIPTION] = true;
        }
    ...
    public function setMetaKeywords($v)
    {
        ...
        if ($this->meta_keywords !== $v) {
            ...
            $this->modifiedColumns[SelectionI18nTableMap::META_KEYWORDS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SelectionI18nTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SelectionI18nTableMap::translateFieldName('Locale', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        if ($this->aSelection !== null && $this->id !== $this->aSelection->getId()) {
            $this->aSelection = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSelectionI18nQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SelectionI18n::setDeleted()
     * @see SelectionI18n::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSelectionI18nQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SelectionI18nTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SelectionI18nTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SelectionI18nTableMap::LOCALE)) {
        ...
        if ($this->isColumnModified(SelectionI18nTableMap::POSTSCRIPTUM)) {
            $modifiedColumns[':p' . $index++]  = 'POSTSCRIPTUM';
        }
        if ($this->isColumnModified(SelectionI18nTableMap::META_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'META_TITLE';
        }
        if ($this->isColumnModified(SelectionI18nTableMap::META_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'META_DESCRIPTION';
        }
        if ($this->isColumnModified(SelectionI18nTableMap::META_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = 'META_KEYWORDS';
        }

        $sql = sprintf(
            'INSERT INTO selection_i18n (%s) VALUES (%s)',
    ...
    {
        $pos = SelectionI18nTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SelectionI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SelectionI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = SelectionI18nTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SelectionI18nTableMap::META_DESCRIPTION)) $criteria->add(SelectionI18nTableMap::META_DESCRIPTION, $this->meta_description);
        if ($this->isColumnModified(SelectionI18nTableMap::META_KEYWORDS)) $criteria->add(SelectionI18nTableMap::META_KEYWORDS, $this->meta_keywords);
    ...
    {
        $criteria = new Criteria(SelectionI18nTableMap::DATABASE_NAME);
        $criteria->add(SelectionI18nTableMap::ID, $this->id);
        $criteria->add(SelectionI18nTableMap::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Selection\Model\SelectionI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Selection\Model\SelectionI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aSelection === null && ($this->id !== null)) {
            $this->aSelection = ChildSelectionQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSelection->addSelectionI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SelectionI18nTableMap::DEFAULT_STRING_FORMAT);
    }
