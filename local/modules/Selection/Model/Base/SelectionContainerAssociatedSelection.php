...
abstract class SelectionContainerAssociatedSelection implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Selection\\Model\\Map\\SelectionContainerAssociatedSelectionTableMap';
    ...
    /**
     * Initializes internal state of Selection\Model\Base\SelectionContainerAssociatedSelection object.
     */
    ...
    /**
     * Compares this with another <code>SelectionContainerAssociatedSelection</code> instance.  If
     * <code>obj</code> is an instance of <code>SelectionContainerAssociatedSelection</code>, delegates to
     * <code>equals(SelectionContainerAssociatedSelection)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return SelectionContainerAssociatedSelection The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SelectionContainerAssociatedSelectionTableMap::ID] = true;
        }
    ...
    public function setSelectionContainerId($v)
    {
        ...
        if ($this->selection_container_id !== $v) {
            ...
            $this->modifiedColumns[SelectionContainerAssociatedSelectionTableMap::SELECTION_CONTAINER_ID] = true;
        }
    ...
    public function setSelectionId($v)
    {
        ...
        if ($this->selection_id !== $v) {
            $this->selection_id = $v;
            $this->modifiedColumns[SelectionContainerAssociatedSelectionTableMap::SELECTION_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[SelectionContainerAssociatedSelectionTableMap::CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SelectionContainerAssociatedSelectionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SelectionContainerAssociatedSelectionTableMap::translateFieldName('SelectionContainerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selection_container_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SelectionContainerAssociatedSelectionTableMap::translateFieldName('SelectionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selection_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SelectionContainerAssociatedSelectionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SelectionContainerAssociatedSelectionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = SelectionContainerAssociatedSelectionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Selection\Model\SelectionContainerAssociatedSelection object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSelectionContainerAssociatedSelectionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SelectionContainerAssociatedSelection::setDeleted()
     * @see SelectionContainerAssociatedSelection::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSelectionContainerAssociatedSelectionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                SelectionContainerAssociatedSelectionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::SELECTION_CONTAINER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SELECTION_CONTAINER_ID';
        }
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::SELECTION_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO selection_container_associated_selection (%s) VALUES (%s)',
    ...
    {
        $pos = SelectionContainerAssociatedSelectionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SelectionContainerAssociatedSelection'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SelectionContainerAssociatedSelection'][$this->getPrimaryKey()] = true;
        $keys = SelectionContainerAssociatedSelectionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::ID)) $criteria->add(SelectionContainerAssociatedSelectionTableMap::ID, $this->id);
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::SELECTION_CONTAINER_ID)) $criteria->add(SelectionContainerAssociatedSelectionTableMap::SELECTION_CONTAINER_ID, $this->selection_container_id);
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::SELECTION_ID)) $criteria->add(SelectionContainerAssociatedSelectionTableMap::SELECTION_ID, $this->selection_id);
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::CREATED_AT)) $criteria->add(SelectionContainerAssociatedSelectionTableMap::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SelectionContainerAssociatedSelectionTableMap::UPDATED_AT)) $criteria->add(SelectionContainerAssociatedSelectionTableMap::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SelectionContainerAssociatedSelectionTableMap::DATABASE_NAME);
        $criteria->add(SelectionContainerAssociatedSelectionTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Selection\Model\SelectionContainerAssociatedSelection (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Selection\Model\SelectionContainerAssociatedSelection Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSelectionContainer(ChildSelectionContainer $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSelectionContainerAssociatedSelection($this);
        }
    ...
    public function getSelectionContainer(ConnectionInterface $con = null)
    {
        if ($this->aSelectionContainer === null && ($this->selection_container_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSelectionContainer->addSelectionContainerAssociatedSelections($this);
             */
        }
    ...
    public function getSelection(ConnectionInterface $con = null)
    {
        if ($this->aSelection === null && ($this->selection_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSelection->addSelectionContainerAssociatedSelections($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SelectionContainerAssociatedSelectionTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     ChildSelectionContainerAssociatedSelection The current object (for fluent API support)
     */
