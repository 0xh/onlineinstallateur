...
use Selection\Model\Base\SelectionFeaturesQuery;
 ...
 */
class SelectionFeatureFreeText
  extends BaseI18nLoop
  implements PropelSearchLoopInterface
    {
    ...
    protected function getArgDefinitions()
        ...
        return new ArgumentCollection(
          Argument::createIntTypeArgument('feature', null, true), Argument::createIntTypeArgument('selection'),
          Argument::createIntListTypeArgument('feature_availability'), Argument::createAnyListTypeArgument('free_text'),
          Argument::createIntTypeArgument('selection'), Argument::createAnyListTypeArgument('free_text'),
    ...
    public function buildModelCriteria()
        ...
        $this->configureI18nProcessing(
          ...
          array(
            ...
            'CHAPO',
            'DESCRIPTION',
            'POSTSCRIPTUM'), FeatureAvTableMap::TABLE_NAME, 'FEATURE_AV_ID', true
        );
        ...
        if (null !== $selection = $this->getSelection()) {
            $search->filterBySelectionId($selection, Criteria::EQUAL);
        }
        ...
        foreach ($loopResult->getResultDataCollection() as
          $featureValue) {
            ...
            $loopResultRow
              ...
              ->set("SELECTION_ID", $featureValue->getSelectionId())
              ...
              ->set("POSTSCRIPTUM",
                $featureValue->getVirtualColumn(FeatureAvTableMap::TABLE_NAME . '_i18n_POSTSCRIPTUM'))
