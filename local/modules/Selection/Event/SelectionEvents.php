...
class SelectionEvents
{
    ...
    // FEAUTURES EVENTS
    const SELECTION_FEATURE_DELETE_VALUE = "action.deleteSelectionFeatureValue";
    const SELECTION_FEATURE_UPDATE_VALUE = "action.updateSelectionFeatureValue";
    const SELECTION_FEATURE_CREATE_VALUE = "action.createSelectionFeatureValue";
