...
/**
 * This class defines the structure of the 'crawler_product_listing_version' table.
 *
 *
 *
 ...
 *
 */
class CrawlerProductListingVersionTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'crawler_product_listing_version';
     ...
     */
    const ID = 'crawler_product_listing_version.ID';

    /**
     * the column name for the PRODUCT_BASE_ID field
     */
    const PRODUCT_BASE_ID = 'crawler_product_listing_version.PRODUCT_BASE_ID';

    /**
     * the column name for the HF_POSITION field
     */
    const HF_POSITION = 'crawler_product_listing_version.HF_POSITION';

    /**
     * the column name for the HF_PRICE field
     */
    const HF_PRICE = 'crawler_product_listing_version.HF_PRICE';

    /**
     * the column name for the FIRST_POSITION field
     */
    const FIRST_POSITION = 'crawler_product_listing_version.FIRST_POSITION';

    /**
     * the column name for the FIRST_PRICE field
     */
    const FIRST_PRICE = 'crawler_product_listing_version.FIRST_PRICE';

    /**
     * the column name for the PLATFORM field
     */
    const PLATFORM = 'crawler_product_listing_version.PLATFORM';

    /**
     * the column name for the LINK_PLATFORM_PRODUCT_PAGE field
     */
    const LINK_PLATFORM_PRODUCT_PAGE = 'crawler_product_listing_version.LINK_PLATFORM_PRODUCT_PAGE';

    /**
     * the column name for the LINK_HF_PRODUCT field
     */
    const LINK_HF_PRODUCT = 'crawler_product_listing_version.LINK_HF_PRODUCT';
     ...
     */
    const UPDATED_AT = 'crawler_product_listing_version.UPDATED_AT';

    /**
     * the column name for the VERSION field
     */
    const VERSION = 'crawler_product_listing_version.VERSION';

    /**
     * the column name for the VERSION_CREATED_AT field
     */
    const VERSION_CREATED_AT = 'crawler_product_listing_version.VERSION_CREATED_AT';

    /**
     * the column name for the VERSION_CREATED_BY field
     */
    const VERSION_CREATED_BY = 'crawler_product_listing_version.VERSION_CREATED_BY';

    /**
     * the column name for the PRODUCT_BASE_ID_VERSION field
     */
    const PRODUCT_BASE_ID_VERSION = 'crawler_product_listing_version.PRODUCT_BASE_ID_VERSION';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('PRODUCT_BASE_ID', 'ProductBaseId', 'INTEGER', false, null, null);
        ...
        $this->addColumn('PRODUCT_BASE_ID_VERSION', 'ProductBaseIdVersion', 'INTEGER', false, null, 0);
    } // initialize()
    ...
    {
        return $withPrefix ? CrawlerProductListingVersionTableMap::CLASS_DEFAULT : CrawlerProductListingVersionTableMap::OM_CLASS;
    }
     ...
     * @return array (CrawlerProductListingVersion object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = CrawlerProductListingVersionTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = CrawlerProductListingVersionTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + CrawlerProductListingVersionTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CrawlerProductListingVersionTableMap::OM_CLASS;
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            CrawlerProductListingVersionTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = CrawlerProductListingVersionTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = CrawlerProductListingVersionTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::ID);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::PRODUCT_BASE_ID);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::HF_POSITION);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::HF_PRICE);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::FIRST_POSITION);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::FIRST_PRICE);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::PLATFORM);
            ...
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::VERSION_CREATED_AT);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::VERSION_CREATED_BY);
            $criteria->addSelectColumn(CrawlerProductListingVersionTableMap::PRODUCT_BASE_ID_VERSION);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.PRODUCT_BASE_ID_VERSION');
        }
    }
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(CrawlerProductListingVersionTableMap::DATABASE_NAME)->getTable(CrawlerProductListingVersionTableMap::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getServiceContainer()->getDatabaseMap(CrawlerProductListingVersionTableMap::DATABASE_NAME);
      if (!$dbMap->hasTable(CrawlerProductListingVersionTableMap::TABLE_NAME)) {
        $dbMap->addTableObject(new CrawlerProductListingVersionTableMap());
      }
    }

    /**
     * Performs a DELETE on the database, given a CrawlerProductListingVersion or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or CrawlerProductListingVersion object or primary key or array of primary keys
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CrawlerProductListingVersionTableMap::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CrawlerProductListingVersionTableMap::VERSION, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = CrawlerProductListingVersionQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { CrawlerProductListingVersionTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { CrawlerProductListingVersionTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return CrawlerProductListingVersionQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a CrawlerProductListingVersion or Criteria object.
     *
     * @param mixed               $criteria Criteria or CrawlerProductListingVersion object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from CrawlerProductListingVersion object
        }
...
} // CrawlerProductListingVersionTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
CrawlerProductListingVersionTableMap::buildTableMap();
