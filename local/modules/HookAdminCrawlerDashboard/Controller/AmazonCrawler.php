...
<title dir="ltr">Amazon.de: Buying Choices: Grohe Eurosmart Cosmopolitan Küchenarmatur (hoher Auslauf, Schwenkbereich wählbar) 32843000</title>
    ...
    <div class="a-fixed-left-grid a-spacing-base"><div class="a-fixed-left-grid-inner" style="padding-left:170px">
        ...
        <div id="olpProductDetails" class="a-fixed-left-grid-col a-col-right" style="padding-left:0%;*width:99.6%;float:left;">
                ...
                <div aria-live="polite">
                    ...
                    <h1 class="a-size-large a-spacing-none" role="main">                        <div class="a-section a-spacing-none olpSubHeadingSection">                            <span class="a-size-base a-color-secondary">                            </span>                        </div>                       Grohe Eurosmart Cosmopolitan Küchenarmatur (hoher Auslauf, Schwenkbereich wählbar) 32843000                    </h1>                </div>
