<?php
    ...
    class BMDOrderExtendedExport extends AbstractExport
    {
        ...
        protected $orderAndAliases = [
            ...
            OrderTableMap::TRANSACTION_REF => 'trans_ref'
        ];
        ...
        public function applyOrderAndAliases(array $data)
        {
            ...
            Tlog::getInstance()->error("processed data output, FROMDB: " . $fromDBVAT . " COMPUTED" . $computedVAT);
            ...
            Tlog::getInstance()->error(" bmd export " . abs(round($computedVAT - $fromDBVAT, 2)) . " " . $processedData['text'] . " " . $processedData['gkto'] . "URM STEUR " . $processedData['steuer'] . "" . $path);
                ...
                case "ORD":
                    {
                        ...
                        switch ($orderKonto) {
                            case 'A':
                                $processedData['konto'] = "200099";
                                break;
                            case 'B':
                                $processedData['konto'] = "200199";
                                break;
                            case 'C':
                                $processedData['konto'] = "200299";
                                break;
                            case 'D':
                                $processedData['konto'] = "200399";
                                break;
                            case 'E':
                                $processedData['konto'] = "200499";
                                break;
                            case 'F':
                                $processedData['konto'] = "200599";
                                break;
                            case 'G':
                                $processedData['konto'] = "200699";
                                break;
                            case 'H':
                                $processedData['konto'] = "200799";
                                break;
                            case 'I':
                                $processedData['konto'] = "200899";
                                break;
                            case 'J':
                                $processedData['konto'] = "200999";
                                break;
                            case 'K':
                                $processedData['konto'] = "201099";
                                break;
                            case 'L':
                                $processedData['konto'] = "201199";
                                break;
                            case 'M':
                                $processedData['konto'] = "201299";
                                break;
                            case 'N':
                                $processedData['konto'] = "201399";
                                break;
                            case 'O':
                                $processedData['konto'] = "201499";
                                break;
                            case 'P':
                                $processedData['konto'] = "201599";
                                break;
                            case 'R':
                                $processedData['konto'] = "201799";
                                break;
                            case 'S':
                                $processedData['konto'] = "201899";
                                break;
                            case 'T':
                                $processedData['konto'] = "201999";
                                break;
                            case 'U':
                                $processedData['konto'] = "202099";
                                break;
                            case 'V':
                                $processedData['konto'] = "202199";
                                break;
                            case 'W':
                                $processedData['konto'] = "202299";
                                break;
                            case 'X':
                                $processedData['konto'] = "202399";
                                break;
                            case 'Z':
                                $processedData['konto'] = "202599";
                                break;
                            default:
                                $processedData['konto'] = "201599";
                        }
        ...
        public function current()
        {
            ...
            $query = OrderQuery::create()
                ...
                ->addAsColumn(
                    'product_TAX', 'IF(' . OrderProductTableMap::WAS_IN_PROMO . ',' .
                ...
                ->addAsColumn(
                    'product_PRICE', 'IF(' . OrderProductTableMap::WAS_IN_PROMO . ',' .
                ...
                ->select([
                    ...
                    'order_status_TITLE',
                    'currency_CODE',
                    OrderTableMap::TRANSACTION_REF,
                    OrderTableMap::CREATED_AT,
                ])
                ->orderByCreatedAt(Criteria::DESC);
            
            I18n::addI18nCondition(
                $query, CustomerTitleI18nTableMap::TABLE_NAME, '`delivery_address_customer_title_join`.ID', CustomerTitleI18nTableMap::ID, '`delivery_address_customer_title_i18n_join`.LOCALE', $locale
            );
            
            I18n::addI18nCondition(
                $query, CustomerTitleI18nTableMap::TABLE_NAME, '`invoice_address_customer_title_join`.ID', CustomerTitleI18nTableMap::ID, '`invoice_address_customer_title_i18n_join`.LOCALE', $locale
            );
            
            I18n::addI18nCondition(
                $query, CountryI18nTableMap::TABLE_NAME, '`delivery_address_country_join`.ID', CountryI18nTableMap::ID, '`delivery_address_country_i18n_join`.LOCALE', $locale
            );
            
            I18n::addI18nCondition(
                $query, CountryI18nTableMap::TABLE_NAME, '`invoice_address_country_join`.ID', CountryI18nTableMap::ID, '`invoice_address_country_i18n_join`.LOCALE', $locale
            );
