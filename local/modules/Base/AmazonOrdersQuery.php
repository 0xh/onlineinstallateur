...
abstract class AmazonOrdersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\AmazonOrdersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\AmazonOrders', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \AmazonOrdersQuery) {
            return $criteria;
        }
        $query = new \AmazonOrdersQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \AmazonOrdersVersion object
     *
     * @param \AmazonOrdersVersion|ObjectCollection $amazonOrdersVersion  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildAmazonOrdersQuery The current query, for fluid interface
     */
    ...
    {
        if ($amazonOrdersVersion instanceof \AmazonOrdersVersion) {
            return $this
            ...
            throw new PropelException('filterByAmazonOrdersVersion() only accepts arguments of type \AmazonOrdersVersion or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \AmazonOrdersVersionQuery A secondary query class using the current class as primary query
     */
    public function useAmazonOrdersVersionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'AmazonOrdersVersion', '\AmazonOrdersVersionQuery');
    }
