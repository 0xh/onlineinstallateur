...
abstract class AmazonOrdersVersion implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AmazonOrdersVersionTableMap';
    ...
    /**
     * Initializes internal state of Base\AmazonOrdersVersion object.
     * @see applyDefaults()
     */
     ...
     * @return   \AmazonOrdersVersion The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \AmazonOrdersVersion object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AmazonOrdersVersion (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \AmazonOrdersVersion Clone of current object.
     * @throws PropelException
     */
