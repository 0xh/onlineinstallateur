...
use \AmazonOrders as ChildAmazonOrders;
use \AmazonOrdersQuery as ChildAmazonOrdersQuery;
use \AmazonOrdersVersion as ChildAmazonOrdersVersion;
use \AmazonOrdersVersionQuery as ChildAmazonOrdersVersionQuery;
use \DateTime;
use \Exception;
use \PDO;
use Map\AmazonOrdersTableMap;
use Map\AmazonOrdersVersionTableMap;
...
abstract class AmazonOrders implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AmazonOrdersTableMap';
    ...
    protected $collAmazonOrdersVersionsPartial;
     ...
     */
    protected $amazonOrdersVersionsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of Base\AmazonOrders object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AmazonOrders</code> instance.  If
     * <code>obj</code> is an instance of <code>AmazonOrders</code>, delegates to
     * <code>equals(AmazonOrders)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return AmazonOrders The current object, for fluid interface
     */
     ...
     * @return   \AmazonOrders The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::ID] = true;
        }
    ...
    public function setSellerOrderId($v)
    {
        ...
        if ($this->seller_order_id !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::SELLER_ORDER_ID] = true;
        }
    ...
    public function setPurchaseDate($v)
    {
        ...
        if ($this->purchase_date !== null || $dt !== null) {
            if ($dt !== $this->purchase_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::PURCHASE_DATE] = true;
            }
    ...
    public function setLastUpdateDate($v)
    {
        ...
        if ($this->last_update_date !== null || $dt !== null) {
            if ($dt !== $this->last_update_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::LAST_UPDATE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setOrderStatus($v)
    {
        ...
        if ($this->order_status !== $v) {
            $this->order_status = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_STATUS] = true;
        }
    ...
    public function setFulfillmentChannel($v)
    {
        ...
        if ($this->fulfillment_channel !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::FULFILLMENT_CHANNEL] = true;
        }
    ...
    public function setSalesChannel($v)
    {
        ...
        if ($this->sales_channel !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::SALES_CHANNEL] = true;
        }
    ...
    public function setOrderChannel($v)
    {
        ...
        if ($this->order_channel !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_CHANNEL] = true;
        }
    ...
    public function setShipServiceLevel($v)
    {
        ...
        if ($this->ship_service_level !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::SHIP_SERVICE_LEVEL] = true;
        }
    ...
    public function setOrderTotalCurrencyCode($v)
    {
        ...
        if ($this->order_total_currency_code !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_TOTAL_CURRENCY_CODE] = true;
        }
    ...
    public function setOrderTotalAmount($v)
    {
        ...
        if ($this->order_total_amount !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_TOTAL_AMOUNT] = true;
        }
    ...
    public function setNumberOfItemsShipped($v)
    {
        ...
        if ($this->number_of_items_shipped !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::NUMBER_OF_ITEMS_SHIPPED] = true;
        }
    ...
    public function setNumberOfItemsUnshipped($v)
    {
        ...
        if ($this->number_of_items_unshipped !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::NUMBER_OF_ITEMS_UNSHIPPED] = true;
        }
    ...
    public function setPaymentExecutionDetailCurrencyCode($v)
    {
        ...
        if ($this->payment_execution_detail_currency_code !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_CURRENCY_CODE] = true;
        }
    ...
    public function setPaymentExecutionDetailTotalAmount($v)
    {
        ...
        if ($this->payment_execution_detail_total_amount !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_TOTAL_AMOUNT] = true;
        }
    ...
    public function setPaymentExecutionDetailPaymentMethod($v)
    {
        ...
        if ($this->payment_execution_detail_payment_method !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_PAYMENT_METHOD] = true;
        }
    ...
    public function setPaymentMethod($v)
    {
        ...
        if ($this->payment_method !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PAYMENT_METHOD] = true;
        }
    ...
    public function setPaymentMethodDetail($v)
    {
        ...
        if ($this->payment_method_detail !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PAYMENT_METHOD_DETAIL] = true;
        }
    ...
    public function setMarketplaceId($v)
    {
        ...
        if ($this->marketplace_id !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::MARKETPLACE_ID] = true;
        }
    ...
    public function setBuyerCounty($v)
    {
        ...
        if ($this->buyer_county !== $v) {
            $this->buyer_county = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::BUYER_COUNTY] = true;
        }
    ...
    public function setBuyerTaxInfoCompany($v)
    {
        ...
        if ($this->buyer_tax_info_company !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::BUYER_TAX_INFO_COMPANY] = true;
        }
    ...
    public function setBuyerTaxInfoTaxingRegion($v)
    {
        ...
        if ($this->buyer_tax_info_taxing_region !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::BUYER_TAX_INFO_TAXING_REGION] = true;
        }
    ...
    public function setBuyerTaxInfoTaxName($v)
    {
        ...
        if ($this->buyer_tax_info_tax_name !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_NAME] = true;
        }
    ...
    public function setBuyerTaxInfoTaxValue($v)
    {
        ...
        if ($this->buyer_tax_info_tax_value !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_VALUE] = true;
        }
    ...
    public function setShipmentServiceLevelCategory($v)
    {
        ...
        if ($this->shipment_service_level_category !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::SHIPMENT_SERVICE_LEVEL_CATEGORY] = true;
        }
    ...
    public function setShippedByAmazonTfm($v)
    {
        ...
        if ($this->shipped_by_amazon_tfm !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::SHIPPED_BY_AMAZON_TFM] = true;
        }
    ...
    public function setTfmShipmentStatus($v)
    {
        ...
        if ($this->tfm_shipment_status !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::TFM_SHIPMENT_STATUS] = true;
        }
    ...
    public function setCbaDisplayableShippingLabel($v)
    {
        ...
        if ($this->cba_displayable_shipping_label !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::CBA_DISPLAYABLE_SHIPPING_LABEL] = true;
        }
    ...
    public function setOrderType($v)
    {
        ...
        if ($this->order_type !== $v) {
            $this->order_type = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_TYPE] = true;
        }
    ...
    public function setEarliestShipDate($v)
    {
        ...
        if ($this->earliest_ship_date !== null || $dt !== null) {
            if ($dt !== $this->earliest_ship_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::EARLIEST_SHIP_DATE] = true;
            }
        } // if either are not null
    ...
    public function setLatestShipDate($v)
    {
        ...
        if ($this->latest_ship_date !== null || $dt !== null) {
            if ($dt !== $this->latest_ship_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::LATEST_SHIP_DATE] = true;
            }
        } // if either are not null
    ...
    public function setEarliestDeliveryDate($v)
    {
        ...
        if ($this->earliest_delivery_date !== null || $dt !== null) {
            if ($dt !== $this->earliest_delivery_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::EARLIEST_DELIVERY_DATE] = true;
            }
        } // if either are not null
    ...
    public function setLatestDeliveryDate($v)
    {
        ...
        if ($this->latest_delivery_date !== null || $dt !== null) {
            if ($dt !== $this->latest_delivery_date) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::LATEST_DELIVERY_DATE] = true;
            }
        } // if either are not null
    ...
    public function setIsBusinessOrder($v)
    {
        ...
        if ($this->is_business_order !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::IS_BUSINESS_ORDER] = true;
        }
    ...
    public function setPurchaseOrderNumber($v)
    {
        ...
        if ($this->purchase_order_number !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::PURCHASE_ORDER_NUMBER] = true;
        }
    ...
    public function setIsPrime($v)
    {
        ...
        if ($this->is_prime !== $v) {
            $this->is_prime = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::IS_PRIME] = true;
        }
    ...
    public function setIsPremiumOrder($v)
    {
        ...
        if ($this->is_premium_order !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::IS_PREMIUM_ORDER] = true;
        }
    ...
    public function setReplacedOrderId($v)
    {
        ...
        if ($this->replaced_order_id !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::REPLACED_ORDER_ID] = true;
        }
    ...
    public function setIsReplacementOrder($v)
    {
        ...
        if ($this->is_replacement_order !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::IS_REPLACEMENT_ORDER] = true;
        }
    ...
    public function setOrderAddressId($v)
    {
        ...
        if ($this->order_address_id !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_ADDRESS_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::CUSTOMER_ID] = true;
        }
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::ORDER_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[AmazonOrdersTableMap::CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[AmazonOrdersTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[AmazonOrdersTableMap::VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($dt !== $this->version_created_at) {
                ...
                $this->modifiedColumns[AmazonOrdersTableMap::VERSION_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[AmazonOrdersTableMap::VERSION_CREATED_BY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AmazonOrdersTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AmazonOrdersTableMap::translateFieldName('SellerOrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->seller_order_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AmazonOrdersTableMap::translateFieldName('PurchaseDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->purchase_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AmazonOrdersTableMap::translateFieldName('LastUpdateDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->last_update_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AmazonOrdersTableMap::translateFieldName('FulfillmentChannel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fulfillment_channel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AmazonOrdersTableMap::translateFieldName('SalesChannel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sales_channel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderChannel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_channel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AmazonOrdersTableMap::translateFieldName('ShipServiceLevel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ship_service_level = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderTotalCurrencyCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_total_currency_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderTotalAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_total_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AmazonOrdersTableMap::translateFieldName('NumberOfItemsShipped', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number_of_items_shipped = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AmazonOrdersTableMap::translateFieldName('NumberOfItemsUnshipped', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number_of_items_unshipped = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AmazonOrdersTableMap::translateFieldName('PaymentExecutionDetailCurrencyCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_execution_detail_currency_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AmazonOrdersTableMap::translateFieldName('PaymentExecutionDetailTotalAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_execution_detail_total_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AmazonOrdersTableMap::translateFieldName('PaymentExecutionDetailPaymentMethod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_execution_detail_payment_method = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AmazonOrdersTableMap::translateFieldName('PaymentMethod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_method = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AmazonOrdersTableMap::translateFieldName('PaymentMethodDetail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_method_detail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AmazonOrdersTableMap::translateFieldName('MarketplaceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->marketplace_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AmazonOrdersTableMap::translateFieldName('BuyerCounty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buyer_county = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AmazonOrdersTableMap::translateFieldName('BuyerTaxInfoCompany', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buyer_tax_info_company = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AmazonOrdersTableMap::translateFieldName('BuyerTaxInfoTaxingRegion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buyer_tax_info_taxing_region = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AmazonOrdersTableMap::translateFieldName('BuyerTaxInfoTaxName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buyer_tax_info_tax_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AmazonOrdersTableMap::translateFieldName('BuyerTaxInfoTaxValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->buyer_tax_info_tax_value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AmazonOrdersTableMap::translateFieldName('ShipmentServiceLevelCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipment_service_level_category = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AmazonOrdersTableMap::translateFieldName('ShippedByAmazonTfm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipped_by_amazon_tfm = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AmazonOrdersTableMap::translateFieldName('TfmShipmentStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tfm_shipment_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AmazonOrdersTableMap::translateFieldName('CbaDisplayableShippingLabel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cba_displayable_shipping_label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AmazonOrdersTableMap::translateFieldName('EarliestShipDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->earliest_ship_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AmazonOrdersTableMap::translateFieldName('LatestShipDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->latest_ship_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AmazonOrdersTableMap::translateFieldName('EarliestDeliveryDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->earliest_delivery_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AmazonOrdersTableMap::translateFieldName('LatestDeliveryDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->latest_delivery_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AmazonOrdersTableMap::translateFieldName('IsBusinessOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_business_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AmazonOrdersTableMap::translateFieldName('PurchaseOrderNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->purchase_order_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AmazonOrdersTableMap::translateFieldName('IsPrime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_prime = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AmazonOrdersTableMap::translateFieldName('IsPremiumOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_premium_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AmazonOrdersTableMap::translateFieldName('ReplacedOrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->replaced_order_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AmazonOrdersTableMap::translateFieldName('IsReplacementOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_replacement_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderAddressId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_address_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AmazonOrdersTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AmazonOrdersTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AmazonOrdersTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AmazonOrdersTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AmazonOrdersTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AmazonOrdersTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AmazonOrdersTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 47; // 47 = AmazonOrdersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \AmazonOrders object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAmazonOrdersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AmazonOrders::setDeleted()
     * @see AmazonOrders::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildAmazonOrdersQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($this->isVersioningNecessary()) {
                ...
                if (!$this->isColumnModified(AmazonOrdersTableMap::VERSION_CREATED_AT)) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(AmazonOrdersTableMap::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(AmazonOrdersTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AmazonOrdersTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                AmazonOrdersTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->amazonOrdersVersionsScheduledForDeletion !== null) {
                if (!$this->amazonOrdersVersionsScheduledForDeletion->isEmpty()) {
                    \AmazonOrdersVersionQuery::create()
                        ->filterByPrimaryKeys($this->amazonOrdersVersionsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->amazonOrdersVersionsScheduledForDeletion = null;
                }
            }

                if ($this->collAmazonOrdersVersions !== null) {
            foreach ($this->collAmazonOrdersVersions as $referrerFK) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AmazonOrdersTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::SELLER_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SELLER_ORDER_ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PURCHASE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'PURCHASE_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::LAST_UPDATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'LAST_UPDATE_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_STATUS';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::FULFILLMENT_CHANNEL)) {
            $modifiedColumns[':p' . $index++]  = 'FULFILLMENT_CHANNEL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::SALES_CHANNEL)) {
            $modifiedColumns[':p' . $index++]  = 'SALES_CHANNEL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_CHANNEL)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_CHANNEL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIP_SERVICE_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'SHIP_SERVICE_LEVEL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TOTAL_CURRENCY_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_TOTAL_CURRENCY_CODE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TOTAL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_TOTAL_AMOUNT';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::NUMBER_OF_ITEMS_SHIPPED)) {
            $modifiedColumns[':p' . $index++]  = 'NUMBER_OF_ITEMS_SHIPPED';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::NUMBER_OF_ITEMS_UNSHIPPED)) {
            $modifiedColumns[':p' . $index++]  = 'NUMBER_OF_ITEMS_UNSHIPPED';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_CURRENCY_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_EXECUTION_DETAIL_CURRENCY_CODE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_TOTAL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_EXECUTION_DETAIL_TOTAL_AMOUNT';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_PAYMENT_METHOD)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_EXECUTION_DETAIL_PAYMENT_METHOD';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_METHOD)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_METHOD';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_METHOD_DETAIL)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_METHOD_DETAIL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::MARKETPLACE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'MARKETPLACE_ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_COUNTY)) {
            $modifiedColumns[':p' . $index++]  = 'BUYER_COUNTY';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_COMPANY)) {
            $modifiedColumns[':p' . $index++]  = 'BUYER_TAX_INFO_COMPANY';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAXING_REGION)) {
            $modifiedColumns[':p' . $index++]  = 'BUYER_TAX_INFO_TAXING_REGION';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'BUYER_TAX_INFO_TAX_NAME';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'BUYER_TAX_INFO_TAX_VALUE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIPMENT_SERVICE_LEVEL_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'SHIPMENT_SERVICE_LEVEL_CATEGORY';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIPPED_BY_AMAZON_TFM)) {
            $modifiedColumns[':p' . $index++]  = 'SHIPPED_BY_AMAZON_TFM';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::TFM_SHIPMENT_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'TFM_SHIPMENT_STATUS';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::CBA_DISPLAYABLE_SHIPPING_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'CBA_DISPLAYABLE_SHIPPING_LABEL';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_TYPE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::EARLIEST_SHIP_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'EARLIEST_SHIP_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::LATEST_SHIP_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'LATEST_SHIP_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::EARLIEST_DELIVERY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'EARLIEST_DELIVERY_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::LATEST_DELIVERY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'LATEST_DELIVERY_DATE';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_BUSINESS_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'IS_BUSINESS_ORDER';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::PURCHASE_ORDER_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'PURCHASE_ORDER_NUMBER';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_PRIME)) {
            $modifiedColumns[':p' . $index++]  = 'IS_PRIME';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_PREMIUM_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'IS_PREMIUM_ORDER';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::REPLACED_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'REPLACED_ORDER_ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_REPLACEMENT_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'IS_REPLACEMENT_ORDER';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_ADDRESS_ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CUSTOMER_ID';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_ID)) {
        ...
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_AT';
        }
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_BY';
        }

        $sql = sprintf(
            'INSERT INTO amazon_orders (%s) VALUES (%s)',
    ...
    {
        $pos = AmazonOrdersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AmazonOrders'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AmazonOrders'][$this->getPrimaryKey()] = true;
        $keys = AmazonOrdersTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AmazonOrdersTableMap::ID)) $criteria->add(AmazonOrdersTableMap::ID, $this->id);
        if ($this->isColumnModified(AmazonOrdersTableMap::SELLER_ORDER_ID)) $criteria->add(AmazonOrdersTableMap::SELLER_ORDER_ID, $this->seller_order_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::PURCHASE_DATE)) $criteria->add(AmazonOrdersTableMap::PURCHASE_DATE, $this->purchase_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::LAST_UPDATE_DATE)) $criteria->add(AmazonOrdersTableMap::LAST_UPDATE_DATE, $this->last_update_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_STATUS)) $criteria->add(AmazonOrdersTableMap::ORDER_STATUS, $this->order_status);
        if ($this->isColumnModified(AmazonOrdersTableMap::FULFILLMENT_CHANNEL)) $criteria->add(AmazonOrdersTableMap::FULFILLMENT_CHANNEL, $this->fulfillment_channel);
        if ($this->isColumnModified(AmazonOrdersTableMap::SALES_CHANNEL)) $criteria->add(AmazonOrdersTableMap::SALES_CHANNEL, $this->sales_channel);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_CHANNEL)) $criteria->add(AmazonOrdersTableMap::ORDER_CHANNEL, $this->order_channel);
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIP_SERVICE_LEVEL)) $criteria->add(AmazonOrdersTableMap::SHIP_SERVICE_LEVEL, $this->ship_service_level);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TOTAL_CURRENCY_CODE)) $criteria->add(AmazonOrdersTableMap::ORDER_TOTAL_CURRENCY_CODE, $this->order_total_currency_code);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TOTAL_AMOUNT)) $criteria->add(AmazonOrdersTableMap::ORDER_TOTAL_AMOUNT, $this->order_total_amount);
        if ($this->isColumnModified(AmazonOrdersTableMap::NUMBER_OF_ITEMS_SHIPPED)) $criteria->add(AmazonOrdersTableMap::NUMBER_OF_ITEMS_SHIPPED, $this->number_of_items_shipped);
        if ($this->isColumnModified(AmazonOrdersTableMap::NUMBER_OF_ITEMS_UNSHIPPED)) $criteria->add(AmazonOrdersTableMap::NUMBER_OF_ITEMS_UNSHIPPED, $this->number_of_items_unshipped);
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_CURRENCY_CODE)) $criteria->add(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_CURRENCY_CODE, $this->payment_execution_detail_currency_code);
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_TOTAL_AMOUNT)) $criteria->add(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_TOTAL_AMOUNT, $this->payment_execution_detail_total_amount);
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_PAYMENT_METHOD)) $criteria->add(AmazonOrdersTableMap::PAYMENT_EXECUTION_DETAIL_PAYMENT_METHOD, $this->payment_execution_detail_payment_method);
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_METHOD)) $criteria->add(AmazonOrdersTableMap::PAYMENT_METHOD, $this->payment_method);
        if ($this->isColumnModified(AmazonOrdersTableMap::PAYMENT_METHOD_DETAIL)) $criteria->add(AmazonOrdersTableMap::PAYMENT_METHOD_DETAIL, $this->payment_method_detail);
        if ($this->isColumnModified(AmazonOrdersTableMap::MARKETPLACE_ID)) $criteria->add(AmazonOrdersTableMap::MARKETPLACE_ID, $this->marketplace_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_COUNTY)) $criteria->add(AmazonOrdersTableMap::BUYER_COUNTY, $this->buyer_county);
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_COMPANY)) $criteria->add(AmazonOrdersTableMap::BUYER_TAX_INFO_COMPANY, $this->buyer_tax_info_company);
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAXING_REGION)) $criteria->add(AmazonOrdersTableMap::BUYER_TAX_INFO_TAXING_REGION, $this->buyer_tax_info_taxing_region);
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_NAME)) $criteria->add(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_NAME, $this->buyer_tax_info_tax_name);
        if ($this->isColumnModified(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_VALUE)) $criteria->add(AmazonOrdersTableMap::BUYER_TAX_INFO_TAX_VALUE, $this->buyer_tax_info_tax_value);
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIPMENT_SERVICE_LEVEL_CATEGORY)) $criteria->add(AmazonOrdersTableMap::SHIPMENT_SERVICE_LEVEL_CATEGORY, $this->shipment_service_level_category);
        if ($this->isColumnModified(AmazonOrdersTableMap::SHIPPED_BY_AMAZON_TFM)) $criteria->add(AmazonOrdersTableMap::SHIPPED_BY_AMAZON_TFM, $this->shipped_by_amazon_tfm);
        if ($this->isColumnModified(AmazonOrdersTableMap::TFM_SHIPMENT_STATUS)) $criteria->add(AmazonOrdersTableMap::TFM_SHIPMENT_STATUS, $this->tfm_shipment_status);
        if ($this->isColumnModified(AmazonOrdersTableMap::CBA_DISPLAYABLE_SHIPPING_LABEL)) $criteria->add(AmazonOrdersTableMap::CBA_DISPLAYABLE_SHIPPING_LABEL, $this->cba_displayable_shipping_label);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_TYPE)) $criteria->add(AmazonOrdersTableMap::ORDER_TYPE, $this->order_type);
        if ($this->isColumnModified(AmazonOrdersTableMap::EARLIEST_SHIP_DATE)) $criteria->add(AmazonOrdersTableMap::EARLIEST_SHIP_DATE, $this->earliest_ship_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::LATEST_SHIP_DATE)) $criteria->add(AmazonOrdersTableMap::LATEST_SHIP_DATE, $this->latest_ship_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::EARLIEST_DELIVERY_DATE)) $criteria->add(AmazonOrdersTableMap::EARLIEST_DELIVERY_DATE, $this->earliest_delivery_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::LATEST_DELIVERY_DATE)) $criteria->add(AmazonOrdersTableMap::LATEST_DELIVERY_DATE, $this->latest_delivery_date);
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_BUSINESS_ORDER)) $criteria->add(AmazonOrdersTableMap::IS_BUSINESS_ORDER, $this->is_business_order);
        if ($this->isColumnModified(AmazonOrdersTableMap::PURCHASE_ORDER_NUMBER)) $criteria->add(AmazonOrdersTableMap::PURCHASE_ORDER_NUMBER, $this->purchase_order_number);
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_PRIME)) $criteria->add(AmazonOrdersTableMap::IS_PRIME, $this->is_prime);
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_PREMIUM_ORDER)) $criteria->add(AmazonOrdersTableMap::IS_PREMIUM_ORDER, $this->is_premium_order);
        if ($this->isColumnModified(AmazonOrdersTableMap::REPLACED_ORDER_ID)) $criteria->add(AmazonOrdersTableMap::REPLACED_ORDER_ID, $this->replaced_order_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::IS_REPLACEMENT_ORDER)) $criteria->add(AmazonOrdersTableMap::IS_REPLACEMENT_ORDER, $this->is_replacement_order);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_ADDRESS_ID)) $criteria->add(AmazonOrdersTableMap::ORDER_ADDRESS_ID, $this->order_address_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::CUSTOMER_ID)) $criteria->add(AmazonOrdersTableMap::CUSTOMER_ID, $this->customer_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::ORDER_ID)) $criteria->add(AmazonOrdersTableMap::ORDER_ID, $this->order_id);
        if ($this->isColumnModified(AmazonOrdersTableMap::CREATED_AT)) $criteria->add(AmazonOrdersTableMap::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AmazonOrdersTableMap::UPDATED_AT)) $criteria->add(AmazonOrdersTableMap::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION)) $criteria->add(AmazonOrdersTableMap::VERSION, $this->version);
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION_CREATED_AT)) $criteria->add(AmazonOrdersTableMap::VERSION_CREATED_AT, $this->version_created_at);
        if ($this->isColumnModified(AmazonOrdersTableMap::VERSION_CREATED_BY)) $criteria->add(AmazonOrdersTableMap::VERSION_CREATED_BY, $this->version_created_by);
    ...
    {
        $criteria = new Criteria(AmazonOrdersTableMap::DATABASE_NAME);
        $criteria->add(AmazonOrdersTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AmazonOrders (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \AmazonOrders Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && ($this->customer_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomer->addAmazonOrderss($this);
             */
        }
    ...
    public function getOrderAddress(ConnectionInterface $con = null)
    {
        if ($this->aOrderAddress === null && ($this->order_address_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrderAddress->addAmazonOrderss($this);
             */
        }
    ...
    public function getOrder(ConnectionInterface $con = null)
    {
        if ($this->aOrder === null && ($this->order_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrder->addAmazonOrderss($this);
             */
        }
    ...
    /**
     * Clears out the collAmazonOrdersVersions collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return void
     * @see        addAmazonOrdersVersions()
     */
    public function clearAmazonOrdersVersions()
    {
        $this->collAmazonOrdersVersions = null; // important to set this to NULL since that means it is uninitialized
    }

    /**
     * Reset is the collAmazonOrdersVersions collection loaded partially.
     */
    public function resetPartialAmazonOrdersVersions($v = true)
    {
        $this->collAmazonOrdersVersionsPartial = $v;
    }

    /**
     * Initializes the collAmazonOrdersVersions collection.
     *
     * By default this just sets the collAmazonOrdersVersions collection to an empty array (like clearcollAmazonOrdersVersions());
     ...
     * @return void
     */
    public function initAmazonOrdersVersions($overrideExisting = true)
    {
        if (null !== $this->collAmazonOrdersVersions && !$overrideExisting) {
            return;
        }
        $this->collAmazonOrdersVersions = new ObjectCollection();
        $this->collAmazonOrdersVersions->setModel('\AmazonOrdersVersion');
    }

    /**
     * Gets an array of ChildAmazonOrdersVersion objects which contain a foreign key that references this object.
     *
     ...
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildAmazonOrdersVersion[] List of ChildAmazonOrdersVersion objects
     * @throws PropelException
     */
    public function getAmazonOrdersVersions($criteria = null, ConnectionInterface $con = null)
    {
        $partial = $this->collAmazonOrdersVersionsPartial && !$this->isNew();
        if (null === $this->collAmazonOrdersVersions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAmazonOrdersVersions) {
                // return empty collection
                $this->initAmazonOrdersVersions();
            } else {
                $collAmazonOrdersVersions = ChildAmazonOrdersVersionQuery::create(null, $criteria)
                    ->filterByAmazonOrders($this)
                    ->find($con);

                if (null !== $criteria) {
                    if (false !== $this->collAmazonOrdersVersionsPartial && count($collAmazonOrdersVersions)) {
                        $this->initAmazonOrdersVersions(false);

                        foreach ($collAmazonOrdersVersions as $obj) {
                            if (false == $this->collAmazonOrdersVersions->contains($obj)) {
                                $this->collAmazonOrdersVersions->append($obj);
                            }
                        }

                        $this->collAmazonOrdersVersionsPartial = true;
                    }

                    reset($collAmazonOrdersVersions);

                    return $collAmazonOrdersVersions;
                }

                if ($partial && $this->collAmazonOrdersVersions) {
                    foreach ($this->collAmazonOrdersVersions as $obj) {
                        if ($obj->isNew()) {
                            $collAmazonOrdersVersions[] = $obj;
                        }
                    }
                }

                $this->collAmazonOrdersVersions = $collAmazonOrdersVersions;
                $this->collAmazonOrdersVersionsPartial = false;
            }
        }

        return $this->collAmazonOrdersVersions;
    }

    /**
     * Sets a collection of AmazonOrdersVersion objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param      Collection $amazonOrdersVersions A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildAmazonOrders The current object (for fluent API support)
     */
    public function setAmazonOrdersVersions(Collection $amazonOrdersVersions, ConnectionInterface $con = null)
    {
        $amazonOrdersVersionsToDelete = $this->getAmazonOrdersVersions(new Criteria(), $con)->diff($amazonOrdersVersions);

        
        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->amazonOrdersVersionsScheduledForDeletion = clone $amazonOrdersVersionsToDelete;

        foreach ($amazonOrdersVersionsToDelete as $amazonOrdersVersionRemoved) {
            $amazonOrdersVersionRemoved->setAmazonOrders(null);
        }

        $this->collAmazonOrdersVersions = null;
        foreach ($amazonOrdersVersions as $amazonOrdersVersion) {
            $this->addAmazonOrdersVersion($amazonOrdersVersion);
        }

        $this->collAmazonOrdersVersions = $amazonOrdersVersions;
        $this->collAmazonOrdersVersionsPartial = false;
    ...
    /**
     * Returns the number of related AmazonOrdersVersion objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related AmazonOrdersVersion objects.
     * @throws PropelException
     */
    public function countAmazonOrdersVersions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collAmazonOrdersVersionsPartial && !$this->isNew();
        if (null === $this->collAmazonOrdersVersions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAmazonOrdersVersions) {
            ...
            if ($partial && !$criteria) {
                return count($this->getAmazonOrdersVersions());
            }

            $query = ChildAmazonOrdersVersionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collAmazonOrdersVersions);
    }

    /**
     * Method called to associate a ChildAmazonOrdersVersion object to this object
     * through the ChildAmazonOrdersVersion foreign key attribute.
     *
     * @param    ChildAmazonOrdersVersion $l ChildAmazonOrdersVersion
     * @return   \AmazonOrders The current object (for fluent API support)
     */
    public function addAmazonOrdersVersion(ChildAmazonOrdersVersion $l)
    {
        if ($this->collAmazonOrdersVersions === null) {
            $this->initAmazonOrdersVersions();
            $this->collAmazonOrdersVersionsPartial = true;
        ...
        if (!in_array($l, $this->collAmazonOrdersVersions->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddAmazonOrdersVersion($l);
        }
    ...
    /**
     * @param AmazonOrdersVersion $amazonOrdersVersion The amazonOrdersVersion object to add.
     */
    protected function doAddAmazonOrdersVersion($amazonOrdersVersion)
    {
        $this->collAmazonOrdersVersions[]= $amazonOrdersVersion;
        $amazonOrdersVersion->setAmazonOrders($this);
    }

    /**
     * @param  AmazonOrdersVersion $amazonOrdersVersion The amazonOrdersVersion object to remove.
     * @return ChildAmazonOrders The current object (for fluent API support)
     */
    public function removeAmazonOrdersVersion($amazonOrdersVersion)
    {
        if ($this->getAmazonOrdersVersions()->contains($amazonOrdersVersion)) {
            $this->collAmazonOrdersVersions->remove($this->collAmazonOrdersVersions->search($amazonOrdersVersion));
            if (null === $this->amazonOrdersVersionsScheduledForDeletion) {
                $this->amazonOrdersVersionsScheduledForDeletion = clone $this->collAmazonOrdersVersions;
                $this->amazonOrdersVersionsScheduledForDeletion->clear();
            }
            $this->amazonOrdersVersionsScheduledForDeletion[]= clone $amazonOrdersVersion;
            $amazonOrdersVersion->setAmazonOrders(null);
        }
    ...
    {
        return (string) $this->exportTo(AmazonOrdersTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return  ChildAmazonOrdersVersion A version object
     */
    public function addVersion($con = null)
    {
        $this->enforceVersion = false;
    
        $version = new ChildAmazonOrdersVersion();
        $version->setId($this->getId());
        $version->setSellerOrderId($this->getSellerOrderId());
        $version->setPurchaseDate($this->getPurchaseDate());
        $version->setLastUpdateDate($this->getLastUpdateDate());
        $version->setOrderStatus($this->getOrderStatus());
        $version->setFulfillmentChannel($this->getFulfillmentChannel());
        $version->setSalesChannel($this->getSalesChannel());
        $version->setOrderChannel($this->getOrderChannel());
        $version->setShipServiceLevel($this->getShipServiceLevel());
        $version->setOrderTotalCurrencyCode($this->getOrderTotalCurrencyCode());
        $version->setOrderTotalAmount($this->getOrderTotalAmount());
        $version->setNumberOfItemsShipped($this->getNumberOfItemsShipped());
        $version->setNumberOfItemsUnshipped($this->getNumberOfItemsUnshipped());
        $version->setPaymentExecutionDetailCurrencyCode($this->getPaymentExecutionDetailCurrencyCode());
        $version->setPaymentExecutionDetailTotalAmount($this->getPaymentExecutionDetailTotalAmount());
        $version->setPaymentExecutionDetailPaymentMethod($this->getPaymentExecutionDetailPaymentMethod());
        $version->setPaymentMethod($this->getPaymentMethod());
        $version->setPaymentMethodDetail($this->getPaymentMethodDetail());
        $version->setMarketplaceId($this->getMarketplaceId());
        $version->setBuyerCounty($this->getBuyerCounty());
        $version->setBuyerTaxInfoCompany($this->getBuyerTaxInfoCompany());
        $version->setBuyerTaxInfoTaxingRegion($this->getBuyerTaxInfoTaxingRegion());
        $version->setBuyerTaxInfoTaxName($this->getBuyerTaxInfoTaxName());
        $version->setBuyerTaxInfoTaxValue($this->getBuyerTaxInfoTaxValue());
        $version->setShipmentServiceLevelCategory($this->getShipmentServiceLevelCategory());
        $version->setShippedByAmazonTfm($this->getShippedByAmazonTfm());
        $version->setTfmShipmentStatus($this->getTfmShipmentStatus());
        $version->setCbaDisplayableShippingLabel($this->getCbaDisplayableShippingLabel());
        $version->setOrderType($this->getOrderType());
        $version->setEarliestShipDate($this->getEarliestShipDate());
        $version->setLatestShipDate($this->getLatestShipDate());
        $version->setEarliestDeliveryDate($this->getEarliestDeliveryDate());
        $version->setLatestDeliveryDate($this->getLatestDeliveryDate());
        $version->setIsBusinessOrder($this->getIsBusinessOrder());
        $version->setPurchaseOrderNumber($this->getPurchaseOrderNumber());
        $version->setIsPrime($this->getIsPrime());
        $version->setIsPremiumOrder($this->getIsPremiumOrder());
        $version->setReplacedOrderId($this->getReplacedOrderId());
        $version->setIsReplacementOrder($this->getIsReplacementOrder());
        $version->setOrderAddressId($this->getOrderAddressId());
    ...
    public function toVersion($versionNumber, $con = null)
    {
        ...
        if (!$version) {
            throw new PropelException(sprintf('No ChildAmazonOrders object found with version %d', $version));
        }
     ...
     * Sets the properties of the current object to the value they had at a specific version
     *
     * @param ChildAmazonOrdersVersion $version The version object to use
     * @param ConnectionInterface   $con the connection to use
    ...
    {
        $loadedObjects['ChildAmazonOrders'][$version->getId()][$version->getVersion()] = $this;
        $this->setId($version->getId());
        $this->setSellerOrderId($version->getSellerOrderId());
        $this->setPurchaseDate($version->getPurchaseDate());
        $this->setLastUpdateDate($version->getLastUpdateDate());
        $this->setOrderStatus($version->getOrderStatus());
        $this->setFulfillmentChannel($version->getFulfillmentChannel());
        $this->setSalesChannel($version->getSalesChannel());
        $this->setOrderChannel($version->getOrderChannel());
        $this->setShipServiceLevel($version->getShipServiceLevel());
        $this->setOrderTotalCurrencyCode($version->getOrderTotalCurrencyCode());
        $this->setOrderTotalAmount($version->getOrderTotalAmount());
        $this->setNumberOfItemsShipped($version->getNumberOfItemsShipped());
        $this->setNumberOfItemsUnshipped($version->getNumberOfItemsUnshipped());
        $this->setPaymentExecutionDetailCurrencyCode($version->getPaymentExecutionDetailCurrencyCode());
        $this->setPaymentExecutionDetailTotalAmount($version->getPaymentExecutionDetailTotalAmount());
        $this->setPaymentExecutionDetailPaymentMethod($version->getPaymentExecutionDetailPaymentMethod());
        $this->setPaymentMethod($version->getPaymentMethod());
        $this->setPaymentMethodDetail($version->getPaymentMethodDetail());
        $this->setMarketplaceId($version->getMarketplaceId());
        $this->setBuyerCounty($version->getBuyerCounty());
        $this->setBuyerTaxInfoCompany($version->getBuyerTaxInfoCompany());
        $this->setBuyerTaxInfoTaxingRegion($version->getBuyerTaxInfoTaxingRegion());
        $this->setBuyerTaxInfoTaxName($version->getBuyerTaxInfoTaxName());
        $this->setBuyerTaxInfoTaxValue($version->getBuyerTaxInfoTaxValue());
        $this->setShipmentServiceLevelCategory($version->getShipmentServiceLevelCategory());
        $this->setShippedByAmazonTfm($version->getShippedByAmazonTfm());
        $this->setTfmShipmentStatus($version->getTfmShipmentStatus());
        $this->setCbaDisplayableShippingLabel($version->getCbaDisplayableShippingLabel());
        $this->setOrderType($version->getOrderType());
        $this->setEarliestShipDate($version->getEarliestShipDate());
        $this->setLatestShipDate($version->getLatestShipDate());
        $this->setEarliestDeliveryDate($version->getEarliestDeliveryDate());
        $this->setLatestDeliveryDate($version->getLatestDeliveryDate());
        $this->setIsBusinessOrder($version->getIsBusinessOrder());
        $this->setPurchaseOrderNumber($version->getPurchaseOrderNumber());
        $this->setIsPrime($version->getIsPrime());
        $this->setIsPremiumOrder($version->getIsPremiumOrder());
        $this->setReplacedOrderId($version->getReplacedOrderId());
        $this->setIsReplacementOrder($version->getIsReplacementOrder());
        $this->setOrderAddressId($version->getOrderAddressId());
    ...
    {
        $v = ChildAmazonOrdersVersionQuery::create()
            ->filterByAmazonOrders($this)
            ->orderByVersion('desc')
            ->findOne($con);
        if (!$v) {
    ...
    {
        return ChildAmazonOrdersVersionQuery::create()
            ->filterByAmazonOrders($this)
     ...
     * @param   ConnectionInterface $con the connection to use
     *
     * @return  ObjectCollection A list of ChildAmazonOrdersVersion objects
     */
    public function getAllVersions($con = null)
    {
        $criteria = new Criteria();
        $criteria->addAscendingOrderByColumn(AmazonOrdersVersionTableMap::VERSION);
    
        return $this->getAmazonOrdersVersions($criteria, $con);
    }
     ...
     * @return PropelCollection|array \AmazonOrdersVersion[] List of \AmazonOrdersVersion objects
     */
    public function getLastVersions($number = 10, $criteria = null, $con = null)
    {
        $criteria = ChildAmazonOrdersVersionQuery::create(null, $criteria);
        $criteria->addDescendingOrderByColumn(AmazonOrdersVersionTableMap::VERSION);
