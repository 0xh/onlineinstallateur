...
abstract class AmazonOrdersVersionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\AmazonOrdersVersionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\AmazonOrdersVersion', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \AmazonOrdersVersionQuery) {
            return $criteria;
        }
        $query = new \AmazonOrdersVersionQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \AmazonOrders object
     *
     * @param \AmazonOrders|ObjectCollection $amazonOrders The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildAmazonOrdersVersionQuery The current query, for fluid interface
     */
    ...
    {
        if ($amazonOrders instanceof \AmazonOrders) {
            return $this
            ...
            throw new PropelException('filterByAmazonOrders() only accepts arguments of type \AmazonOrders or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \AmazonOrdersQuery A secondary query class using the current class as primary query
     */
    public function useAmazonOrdersQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'AmazonOrders', '\AmazonOrdersQuery');
    }
