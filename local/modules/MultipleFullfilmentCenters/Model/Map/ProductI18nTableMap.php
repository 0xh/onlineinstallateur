...
use MultipleFullfilmentCenters\Model\ProductI18n;
use MultipleFullfilmentCenters\Model\ProductI18nQuery;
...
class ProductI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MultipleFullfilmentCenters.Model.Map.ProductI18nTableMap';
     ...
     */
    const OM_CLASS = '\\MultipleFullfilmentCenters\\Model\\ProductI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MultipleFullfilmentCenters.Model.ProductI18n';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MultipleFullfilmentCenters\\Model\\ProductI18n');
    ...
    {
        $this->addRelation('Product', '\\MultipleFullfilmentCenters\\Model\\Product', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \MultipleFullfilmentCenters\Model\ProductI18n $obj A \MultipleFullfilmentCenters\Model\ProductI18n object.
     ...
     *
     * @param mixed $value A \MultipleFullfilmentCenters\Model\ProductI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \MultipleFullfilmentCenters\Model\ProductI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \MultipleFullfilmentCenters\Model\ProductI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MultipleFullfilmentCenters\Model\ProductI18n) { // it's a model object
