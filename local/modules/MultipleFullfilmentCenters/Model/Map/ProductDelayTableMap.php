...
class ProductDelayTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MultipleFullfilmentCenters.Model.Map.ProductDelayTableMap';
     ...
     */
    const OM_CLASS = '\\MultipleFullfilmentCenters\\Model\\ProductDelay';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MultipleFullfilmentCenters.Model.ProductDelay';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MultipleFullfilmentCenters\\Model\\ProductDelay');
    ...
    {
        $this->addRelation('Product', '\\MultipleFullfilmentCenters\\Model\\Thelia\\Model\\Product', RelationMap::MANY_TO_ONE, array('product_id' => 'id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MultipleFullfilmentCenters\Model\ProductDelay) { // it's a model object
