...
abstract class ProductI18n implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MultipleFullfilmentCenters\\Model\\Map\\ProductI18nTableMap';
    ...
    /**
     * Initializes internal state of MultipleFullfilmentCenters\Model\Base\ProductI18n object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ProductI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductI18n</code>, delegates to
     * <code>equals(ProductI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \MultipleFullfilmentCenters\Model\ProductI18n object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MultipleFullfilmentCenters\Model\ProductI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \MultipleFullfilmentCenters\Model\ProductI18n Clone of current object.
     * @throws PropelException
     */
