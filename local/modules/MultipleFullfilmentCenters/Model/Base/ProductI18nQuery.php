...
use MultipleFullfilmentCenters\Model\Map\ProductI18nTableMap;
 ...
 * @method     ChildProductI18nQuery orderByTitle($order = Criteria::ASC) Order by the title column
 ...
 * @method     ChildProductI18nQuery groupByTitle() Group by the title column
 ...
 * @method     ChildProductI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildProductI18nQuery leftJoinProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the Product relation
 * @method     ChildProductI18nQuery rightJoinProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Product relation
 * @method     ChildProductI18nQuery innerJoinProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the Product relation
 *
 * @method     ChildProductI18n findOne(ConnectionInterface $con = null) Return the first ChildProductI18n matching the query
 * @method     ChildProductI18n findOneOrCreate(ConnectionInterface $con = null) Return the first ChildProductI18n matching the query, or a new ChildProductI18n object populated from the query conditions when no match is found
 *
 * @method     ChildProductI18n findOneById(int $id) Return the first ChildProductI18n filtered by the id column
 * @method     ChildProductI18n findOneByLocale(string $locale) Return the first ChildProductI18n filtered by the locale column
 * @method     ChildProductI18n findOneByTitle(string $title) Return the first ChildProductI18n filtered by the title column
 ...
 * @method     array findByTitle(string $title) Return ChildProductI18n objects filtered by the title column
...
abstract class ProductI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \MultipleFullfilmentCenters\Model\Base\ProductI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\MultipleFullfilmentCenters\\Model\\ProductI18n', $modelAlias = null)
    {
     ...
     *
     * @return ChildProductI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof \MultipleFullfilmentCenters\Model\ProductI18nQuery) {
            return $criteria;
        }
        $query = new \MultipleFullfilmentCenters\Model\ProductI18nQuery();
        if (null !== $modelAlias) {
