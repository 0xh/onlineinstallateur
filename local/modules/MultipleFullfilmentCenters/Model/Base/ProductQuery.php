 ...
 *
 * @method     ChildProductQuery leftJoinFulfilmentCenterProducts($relationAlias = null) Adds a LEFT JOIN clause to the query using the FulfilmentCenterProducts relation
 * @method     ChildProductQuery rightJoinFulfilmentCenterProducts($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FulfilmentCenterProducts relation
 * @method     ChildProductQuery innerJoinFulfilmentCenterProducts($relationAlias = null) Adds a INNER JOIN clause to the query using the FulfilmentCenterProducts relation
 *
...
abstract class ProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \MultipleFullfilmentCenters\Model\Base\ProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\MultipleFullfilmentCenters\\Model\\Product', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \MultipleFullfilmentCenters\Model\ProductQuery) {
            return $criteria;
        }
        $query = new \MultipleFullfilmentCenters\Model\ProductQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, TAX_RULE_ID, REF, VISIBLE, POSITION, TEMPLATE_ID, BRAND_ID, VIRTUAL, CREATED_AT, UPDATED_AT FROM product WHERE ID = :p0';
        try {
    ...
    public function filterByFulfilmentCenterProducts($fulfilmentCenterProducts, $comparison = null)
    {
        if ($fulfilmentCenterProducts instanceof \MultipleFullfilmentCenters\Model\FulfilmentCenterProducts) {
            return $this
                ->addUsingAlias(ProductTableMap::ID, $fulfilmentCenterProducts->getProductId(), $comparison);
    ...
    /**
     * Filter the query by a related \MultipleFullfilmentCenters\Model\ProductI18n object
     *
     * @param \MultipleFullfilmentCenters\Model\ProductI18n|ObjectCollection $productI18n  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProductQuery The current query, for fluid interface
     */
    ...
    {
        if ($productI18n instanceof \MultipleFullfilmentCenters\Model\ProductI18n) {
            return $this
            ...
            throw new PropelException('filterByProductI18n() only accepts arguments of type \MultipleFullfilmentCenters\Model\ProductI18n or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \MultipleFullfilmentCenters\Model\ProductI18nQuery A secondary query class using the current class as primary query
     */
    public function useProductI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinProductI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ProductI18n', '\MultipleFullfilmentCenters\Model\ProductI18nQuery');
    }
