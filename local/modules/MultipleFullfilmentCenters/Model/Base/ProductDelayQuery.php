...
use \Exception;
use \PDO;
use MultipleFullfilmentCenters\Model\ProductDelay as ChildProductDelay;
use MultipleFullfilmentCenters\Model\ProductDelayQuery as ChildProductDelayQuery;
use MultipleFullfilmentCenters\Model\Map\ProductDelayTableMap;
use MultipleFullfilmentCenters\Model\Thelia\Model\Product;
...
abstract class ProductDelayQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'thelia', $modelName = '\\MultipleFullfilmentCenters\\Model\\ProductDelay', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \MultipleFullfilmentCenters\Model\ProductDelayQuery) {
            return $criteria;
        }
        $query = new \MultipleFullfilmentCenters\Model\ProductDelayQuery();
        if (null !== $modelAlias) {
    ...
    {
        if ($product instanceof \MultipleFullfilmentCenters\Model\Thelia\Model\Product) {
            return $this
            ...
            throw new PropelException('filterByProduct() only accepts arguments of type \MultipleFullfilmentCenters\Model\Thelia\Model\Product or Collection');
        }
    }
    ...
    public function useProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Product', '\MultipleFullfilmentCenters\Model\Thelia\Model\ProductQuery');
    }
