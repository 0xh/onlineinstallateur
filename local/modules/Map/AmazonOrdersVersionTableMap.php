...
use \AmazonOrdersVersion;
use \AmazonOrdersVersionQuery;
...
class AmazonOrdersVersionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.AmazonOrdersVersionTableMap';
     ...
     */
    const OM_CLASS = '\\AmazonOrdersVersion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AmazonOrdersVersion';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AmazonOrdersVersion');
        $this->setPackage('');
    ...
    {
        $this->addRelation('AmazonOrders', '\\AmazonOrders', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \AmazonOrdersVersion $obj A \AmazonOrdersVersion object.
     ...
     *
     * @param mixed $value A \AmazonOrdersVersion object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \AmazonOrdersVersion) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \AmazonOrdersVersion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AmazonOrdersVersion) { // it's a model object
