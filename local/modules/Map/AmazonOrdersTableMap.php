...
class AmazonOrdersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.AmazonOrdersTableMap';
     ...
     */
    const OM_CLASS = '\\AmazonOrders';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AmazonOrders';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AmazonOrders');
        $this->setPackage('');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AmazonOrdersVersion', '\\AmazonOrdersVersion', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'AmazonOrdersVersions');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AmazonOrders) { // it's a model object
