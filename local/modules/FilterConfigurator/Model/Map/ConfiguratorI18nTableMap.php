...
class ConfiguratorI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FilterConfigurator.Model.Map.ConfiguratorI18nTableMap';
     ...
     */
    const OM_CLASS = '\\FilterConfigurator\\Model\\ConfiguratorI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FilterConfigurator.Model.ConfiguratorI18n';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ConfiguratorI18nTableMap::ID, ConfiguratorI18nTableMap::LOCALE, ConfiguratorI18nTableMap::TITLE, ConfiguratorI18nTableMap::DESCRIPTION, ConfiguratorI18nTableMap::CHAPO, ConfiguratorI18nTableMap::POSTSCRIPTUM, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ConfiguratorI18nTableMap::ID => 0, ConfiguratorI18nTableMap::LOCALE => 1, ConfiguratorI18nTableMap::TITLE => 2, ConfiguratorI18nTableMap::DESCRIPTION => 3, ConfiguratorI18nTableMap::CHAPO => 4, ConfiguratorI18nTableMap::POSTSCRIPTUM => 5, ),
     ...
     * and findPk*() calls.
     *
     * @param \FilterConfigurator\Model\ConfiguratorI18n $obj A \FilterConfigurator\Model\ConfiguratorI18n object.
     ...
     *
     * @param mixed $value A \FilterConfigurator\Model\ConfiguratorI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \FilterConfigurator\Model\ConfiguratorI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \FilterConfigurator\Model\ConfiguratorI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfiguratorI18nTableMap::TITLE);
            $criteria->addSelectColumn(ConfiguratorI18nTableMap::DESCRIPTION);
            $criteria->addSelectColumn(ConfiguratorI18nTableMap::CHAPO);
            $criteria->addSelectColumn(ConfiguratorI18nTableMap::POSTSCRIPTUM);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FilterConfigurator\Model\ConfiguratorI18n) { // it's a model object
