...
class Image extends BaseI18nLoop implements PropelSearchLoopInterface
{
	 ...
	 */
	protected $possible_sources = array('category', 'product', 'folder', 'content', 'module', 'brand','configurator');
	...
	{ 
		$collection = new ArgumentCollection(
				...
				Argument::createIntTypeArgument('configurator'),
