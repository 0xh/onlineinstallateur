<?php
    ...
    class ProductMatchingListener extends BaseAction implements EventSubscriberInterface
    {
        ...
        protected function addNewOrderRevenue($orderProdRevenue, $paymentProcessorCost, $totalPaymentProcessorCost,
                                              $deliveryCostMethod)
        {
