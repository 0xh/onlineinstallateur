...
abstract class OrderProductRevenue implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\RevenueDashboard\\Model\\Map\\OrderProductRevenueTableMap';
    ...
    /**
     * Initializes internal state of RevenueDashboard\Model\Base\OrderProductRevenue object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OrderProductRevenue</code> instance.  If
     * <code>obj</code> is an instance of <code>OrderProductRevenue</code>, delegates to
     * <code>equals(OrderProductRevenue)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return OrderProductRevenue The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OrderProductRevenueTableMap::ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[OrderProductRevenueTableMap::PRICE] = true;
        }
    ...
    public function setPurchasePrice($v)
    {
        ...
        if ($this->purchase_price !== $v) {
            ...
            $this->modifiedColumns[OrderProductRevenueTableMap::PURCHASE_PRICE] = true;
        }
    ...
    public function setPartnerId($v)
    {
        ...
        if ($this->partner_id !== $v) {
            $this->partner_id = $v;
            $this->modifiedColumns[OrderProductRevenueTableMap::PARTNER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrderProductRevenueTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderProductRevenueTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OrderProductRevenueTableMap::translateFieldName('ProductRef', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOrderProductRevenueQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OrderProductRevenue::setDeleted()
     * @see OrderProductRevenue::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildOrderProductRevenueQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrderProductRevenueTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OrderProductRevenueTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(OrderProductRevenueTableMap::ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_ID';
        }
        if ($this->isColumnModified(OrderProductRevenueTableMap::PRODUCT_REF)) {
        ...
        if ($this->isColumnModified(OrderProductRevenueTableMap::PARTNER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PARTNER_ID';
        }

        $sql = sprintf(
            'INSERT INTO order_product_revenue (%s) VALUES (%s)',
    ...
    {
        $pos = OrderProductRevenueTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $alreadyDumpedObjects['OrderProductRevenue'][$this->getPrimaryKey()] = true;
        $keys = OrderProductRevenueTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderProductRevenueTableMap::ID)) $criteria->add(OrderProductRevenueTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(OrderProductRevenueTableMap::DATABASE_NAME);
        $criteria->add(OrderProductRevenueTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RevenueDashboard\Model\OrderProductRevenue (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \RevenueDashboard\Model\OrderProductRevenue Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OrderProductRevenueTableMap::DEFAULT_STRING_FORMAT);
    }
