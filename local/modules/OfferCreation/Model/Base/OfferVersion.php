...
abstract class OfferVersion implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\OfferCreation\\Model\\Map\\OfferVersionTableMap';
    ...
    /**
     * Initializes internal state of OfferCreation\Model\Base\OfferVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OfferVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>OfferVersion</code>, delegates to
     * <code>equals(OfferVersion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return OfferVersion The current object, for fluid interface
     */
     ...
     * @return   \OfferCreation\Model\OfferVersion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OfferVersionTableMap::ID] = true;
        }
    ...
    public function setRef($v)
    {
        ...
        if ($this->ref !== $v) {
            $this->ref = $v;
            $this->modifiedColumns[OfferVersionTableMap::REF] = true;
        }
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::ORDER_ID] = true;
        }
    ...
    public function setOrderRef($v)
    {
        ...
        if ($this->order_ref !== $v) {
            $this->order_ref = $v;
            $this->modifiedColumns[OfferVersionTableMap::ORDER_REF] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::CUSTOMER_ID] = true;
        }
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::EMPLOYEE_ID] = true;
        }
    ...
    public function setInvoiceOrderAddressId($v)
    {
        ...
        if ($this->invoice_order_address_id !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::INVOICE_ORDER_ADDRESS_ID] = true;
        }
    ...
    public function setDeliveryOrderAddressId($v)
    {
        ...
        if ($this->delivery_order_address_id !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::DELIVERY_ORDER_ADDRESS_ID] = true;
        }
    ...
    public function setInvoiceDate($v)
    {
        ...
        if ($this->invoice_date !== null || $dt !== null) {
            if ($dt !== $this->invoice_date) {
                ...
                $this->modifiedColumns[OfferVersionTableMap::INVOICE_DATE] = true;
            }
    ...
    public function setCurrencyId($v)
    {
        ...
        if ($this->currency_id !== $v) {
            $this->currency_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::CURRENCY_ID] = true;
        }
    ...
    public function setCurrencyRate($v)
    {
        ...
        if ($this->currency_rate !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::CURRENCY_RATE] = true;
        }
    ...
    public function setTransactionRef($v)
    {
        ...
        if ($this->transaction_ref !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::TRANSACTION_REF] = true;
        }
    ...
    public function setDeliveryRef($v)
    {
        ...
        if ($this->delivery_ref !== $v) {
            $this->delivery_ref = $v;
            $this->modifiedColumns[OfferVersionTableMap::DELIVERY_REF] = true;
        }
    ...
    public function setInvoiceRef($v)
    {
        ...
        if ($this->invoice_ref !== $v) {
            $this->invoice_ref = $v;
            $this->modifiedColumns[OfferVersionTableMap::INVOICE_REF] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[OfferVersionTableMap::DISCOUNT] = true;
        }
    ...
    public function setPostage($v)
    {
        ...
        if ($this->postage !== $v) {
            $this->postage = $v;
            $this->modifiedColumns[OfferVersionTableMap::POSTAGE] = true;
        }
    ...
    public function setPostageTax($v)
    {
        ...
        if ($this->postage_tax !== $v) {
            $this->postage_tax = $v;
            $this->modifiedColumns[OfferVersionTableMap::POSTAGE_TAX] = true;
        }
    ...
    public function setPostageTaxRuleTitle($v)
    {
        ...
        if ($this->postage_tax_rule_title !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::POSTAGE_TAX_RULE_TITLE] = true;
        }
    ...
    public function setPaymentModuleId($v)
    {
        ...
        if ($this->payment_module_id !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::PAYMENT_MODULE_ID] = true;
        }
    ...
    public function setDeliveryModuleId($v)
    {
        ...
        if ($this->delivery_module_id !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::DELIVERY_MODULE_ID] = true;
        }
    ...
    public function setStatusId($v)
    {
        ...
        if ($this->status_id !== $v) {
            $this->status_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::STATUS_ID] = true;
        }
    ...
    public function setLangId($v)
    {
        ...
        if ($this->lang_id !== $v) {
            $this->lang_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::LANG_ID] = true;
        }
    ...
    public function setCartId($v)
    {
        ...
        if ($this->cart_id !== $v) {
            $this->cart_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::CART_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[OfferVersionTableMap::CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[OfferVersionTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[OfferVersionTableMap::VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($dt !== $this->version_created_at) {
                ...
                $this->modifiedColumns[OfferVersionTableMap::VERSION_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::VERSION_CREATED_BY] = true;
        }
    ...
    public function setNoteEmployee($v)
    {
        ...
        if ($this->note_employee !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::NOTE_EMPLOYEE] = true;
        }
    ...
    public function setChatId($v)
    {
        ...
        if ($this->chat_id !== $v) {
            $this->chat_id = $v;
            $this->modifiedColumns[OfferVersionTableMap::CHAT_ID] = true;
        }
    ...
    public function setCustomerIdVersion($v)
    {
        ...
        if ($this->customer_id_version !== $v) {
            ...
            $this->modifiedColumns[OfferVersionTableMap::CUSTOMER_ID_VERSION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OfferVersionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OfferVersionTableMap::translateFieldName('Ref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OfferVersionTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OfferVersionTableMap::translateFieldName('OrderRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OfferVersionTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OfferVersionTableMap::translateFieldName('EmployeeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employee_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OfferVersionTableMap::translateFieldName('InvoiceOrderAddressId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_order_address_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OfferVersionTableMap::translateFieldName('DeliveryOrderAddressId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_order_address_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OfferVersionTableMap::translateFieldName('InvoiceDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->invoice_date = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : OfferVersionTableMap::translateFieldName('CurrencyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->currency_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : OfferVersionTableMap::translateFieldName('CurrencyRate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->currency_rate = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : OfferVersionTableMap::translateFieldName('TransactionRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transaction_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : OfferVersionTableMap::translateFieldName('DeliveryRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : OfferVersionTableMap::translateFieldName('InvoiceRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : OfferVersionTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : OfferVersionTableMap::translateFieldName('Postage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->postage = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : OfferVersionTableMap::translateFieldName('PostageTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->postage_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : OfferVersionTableMap::translateFieldName('PostageTaxRuleTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->postage_tax_rule_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : OfferVersionTableMap::translateFieldName('PaymentModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_module_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : OfferVersionTableMap::translateFieldName('DeliveryModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_module_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : OfferVersionTableMap::translateFieldName('StatusId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : OfferVersionTableMap::translateFieldName('LangId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lang_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : OfferVersionTableMap::translateFieldName('CartId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cart_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : OfferVersionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : OfferVersionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : OfferVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : OfferVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : OfferVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : OfferVersionTableMap::translateFieldName('NoteEmployee', TableMap::TYPE_PHPNAME, $indexType)];
            $this->note_employee = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : OfferVersionTableMap::translateFieldName('ChatId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chat_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : OfferVersionTableMap::translateFieldName('CustomerIdVersion', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 31; // 31 = OfferVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \OfferCreation\Model\OfferVersion object", 0, $e);
        }
    }
    ...
    {
        if ($this->aOffer !== null && $this->id !== $this->aOffer->getId()) {
            $this->aOffer = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOfferVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OfferVersion::setDeleted()
     * @see OfferVersion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildOfferVersionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OfferVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OfferVersionTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::REF)) {
            $modifiedColumns[':p' . $index++]  = 'REF';
        }
        if ($this->isColumnModified(OfferVersionTableMap::ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::ORDER_REF)) {
            $modifiedColumns[':p' . $index++]  = 'ORDER_REF';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CUSTOMER_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'EMPLOYEE_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_ORDER_ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'INVOICE_ORDER_ADDRESS_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_ORDER_ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DELIVERY_ORDER_ADDRESS_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'INVOICE_DATE';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CURRENCY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CURRENCY_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CURRENCY_RATE)) {
            $modifiedColumns[':p' . $index++]  = 'CURRENCY_RATE';
        }
        if ($this->isColumnModified(OfferVersionTableMap::TRANSACTION_REF)) {
            $modifiedColumns[':p' . $index++]  = 'TRANSACTION_REF';
        }
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_REF)) {
            $modifiedColumns[':p' . $index++]  = 'DELIVERY_REF';
        }
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_REF)) {
            $modifiedColumns[':p' . $index++]  = 'INVOICE_REF';
        }
        if ($this->isColumnModified(OfferVersionTableMap::DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'DISCOUNT';
        }
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE)) {
            $modifiedColumns[':p' . $index++]  = 'POSTAGE';
        }
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'POSTAGE_TAX';
        }
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE_TAX_RULE_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'POSTAGE_TAX_RULE_TITLE';
        }
        if ($this->isColumnModified(OfferVersionTableMap::PAYMENT_MODULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_MODULE_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_MODULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DELIVERY_MODULE_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::STATUS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'STATUS_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::LANG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'LANG_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CART_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CART_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'CREATED_AT';
        }
        if ($this->isColumnModified(OfferVersionTableMap::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'UPDATED_AT';
        }
        if ($this->isColumnModified(OfferVersionTableMap::VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION';
        }
        if ($this->isColumnModified(OfferVersionTableMap::VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_AT';
        }
        if ($this->isColumnModified(OfferVersionTableMap::VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'VERSION_CREATED_BY';
        }
        if ($this->isColumnModified(OfferVersionTableMap::NOTE_EMPLOYEE)) {
            $modifiedColumns[':p' . $index++]  = 'NOTE_EMPLOYEE';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CHAT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CHAT_ID';
        }
        if ($this->isColumnModified(OfferVersionTableMap::CUSTOMER_ID_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'CUSTOMER_ID_VERSION';
        }

        $sql = sprintf(
            'INSERT INTO offer_version (%s) VALUES (%s)',
    ...
    {
        $pos = OfferVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OfferVersion'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OfferVersion'][serialize($this->getPrimaryKey())] = true;
        $keys = OfferVersionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getRef(),
            ...
            $keys[30] => $this->getCustomerIdVersion(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[30], $arr)) $this->setCustomerIdVersion($arr[$keys[30]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OfferVersionTableMap::ID)) $criteria->add(OfferVersionTableMap::ID, $this->id);
        if ($this->isColumnModified(OfferVersionTableMap::REF)) $criteria->add(OfferVersionTableMap::REF, $this->ref);
        if ($this->isColumnModified(OfferVersionTableMap::ORDER_ID)) $criteria->add(OfferVersionTableMap::ORDER_ID, $this->order_id);
        if ($this->isColumnModified(OfferVersionTableMap::ORDER_REF)) $criteria->add(OfferVersionTableMap::ORDER_REF, $this->order_ref);
        if ($this->isColumnModified(OfferVersionTableMap::CUSTOMER_ID)) $criteria->add(OfferVersionTableMap::CUSTOMER_ID, $this->customer_id);
        if ($this->isColumnModified(OfferVersionTableMap::EMPLOYEE_ID)) $criteria->add(OfferVersionTableMap::EMPLOYEE_ID, $this->employee_id);
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_ORDER_ADDRESS_ID)) $criteria->add(OfferVersionTableMap::INVOICE_ORDER_ADDRESS_ID, $this->invoice_order_address_id);
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_ORDER_ADDRESS_ID)) $criteria->add(OfferVersionTableMap::DELIVERY_ORDER_ADDRESS_ID, $this->delivery_order_address_id);
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_DATE)) $criteria->add(OfferVersionTableMap::INVOICE_DATE, $this->invoice_date);
        if ($this->isColumnModified(OfferVersionTableMap::CURRENCY_ID)) $criteria->add(OfferVersionTableMap::CURRENCY_ID, $this->currency_id);
        if ($this->isColumnModified(OfferVersionTableMap::CURRENCY_RATE)) $criteria->add(OfferVersionTableMap::CURRENCY_RATE, $this->currency_rate);
        if ($this->isColumnModified(OfferVersionTableMap::TRANSACTION_REF)) $criteria->add(OfferVersionTableMap::TRANSACTION_REF, $this->transaction_ref);
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_REF)) $criteria->add(OfferVersionTableMap::DELIVERY_REF, $this->delivery_ref);
        if ($this->isColumnModified(OfferVersionTableMap::INVOICE_REF)) $criteria->add(OfferVersionTableMap::INVOICE_REF, $this->invoice_ref);
        if ($this->isColumnModified(OfferVersionTableMap::DISCOUNT)) $criteria->add(OfferVersionTableMap::DISCOUNT, $this->discount);
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE)) $criteria->add(OfferVersionTableMap::POSTAGE, $this->postage);
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE_TAX)) $criteria->add(OfferVersionTableMap::POSTAGE_TAX, $this->postage_tax);
        if ($this->isColumnModified(OfferVersionTableMap::POSTAGE_TAX_RULE_TITLE)) $criteria->add(OfferVersionTableMap::POSTAGE_TAX_RULE_TITLE, $this->postage_tax_rule_title);
        if ($this->isColumnModified(OfferVersionTableMap::PAYMENT_MODULE_ID)) $criteria->add(OfferVersionTableMap::PAYMENT_MODULE_ID, $this->payment_module_id);
        if ($this->isColumnModified(OfferVersionTableMap::DELIVERY_MODULE_ID)) $criteria->add(OfferVersionTableMap::DELIVERY_MODULE_ID, $this->delivery_module_id);
        if ($this->isColumnModified(OfferVersionTableMap::STATUS_ID)) $criteria->add(OfferVersionTableMap::STATUS_ID, $this->status_id);
        if ($this->isColumnModified(OfferVersionTableMap::LANG_ID)) $criteria->add(OfferVersionTableMap::LANG_ID, $this->lang_id);
        if ($this->isColumnModified(OfferVersionTableMap::CART_ID)) $criteria->add(OfferVersionTableMap::CART_ID, $this->cart_id);
        if ($this->isColumnModified(OfferVersionTableMap::CREATED_AT)) $criteria->add(OfferVersionTableMap::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(OfferVersionTableMap::UPDATED_AT)) $criteria->add(OfferVersionTableMap::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(OfferVersionTableMap::VERSION)) $criteria->add(OfferVersionTableMap::VERSION, $this->version);
        if ($this->isColumnModified(OfferVersionTableMap::VERSION_CREATED_AT)) $criteria->add(OfferVersionTableMap::VERSION_CREATED_AT, $this->version_created_at);
        if ($this->isColumnModified(OfferVersionTableMap::VERSION_CREATED_BY)) $criteria->add(OfferVersionTableMap::VERSION_CREATED_BY, $this->version_created_by);
        if ($this->isColumnModified(OfferVersionTableMap::NOTE_EMPLOYEE)) $criteria->add(OfferVersionTableMap::NOTE_EMPLOYEE, $this->note_employee);
        if ($this->isColumnModified(OfferVersionTableMap::CHAT_ID)) $criteria->add(OfferVersionTableMap::CHAT_ID, $this->chat_id);
        if ($this->isColumnModified(OfferVersionTableMap::CUSTOMER_ID_VERSION)) $criteria->add(OfferVersionTableMap::CUSTOMER_ID_VERSION, $this->customer_id_version);
    ...
    {
        $criteria = new Criteria(OfferVersionTableMap::DATABASE_NAME);
        $criteria->add(OfferVersionTableMap::ID, $this->id);
        $criteria->add(OfferVersionTableMap::VERSION, $this->version);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OfferCreation\Model\OfferVersion (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \OfferCreation\Model\OfferVersion Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aOffer === null && ($this->id !== null)) {
            $this->aOffer = ChildOfferQuery::create()->findPk($this->id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOffer->addOfferVersions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OfferVersionTableMap::DEFAULT_STRING_FORMAT);
    }
