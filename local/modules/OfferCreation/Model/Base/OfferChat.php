...
abstract class OfferChat implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\OfferCreation\\Model\\Map\\OfferChatTableMap';
    ...
    /**
     * Initializes internal state of OfferCreation\Model\Base\OfferChat object.
     */
    ...
    /**
     * Compares this with another <code>OfferChat</code> instance.  If
     * <code>obj</code> is an instance of <code>OfferChat</code>, delegates to
     * <code>equals(OfferChat)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return OfferChat The current object, for fluid interface
     */
     ...
     * @return   \OfferCreation\Model\OfferChat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OfferChatTableMap::ID] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[OfferChatTableMap::MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OfferChatTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OfferChatTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = OfferChatTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \OfferCreation\Model\OfferChat object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOfferChatQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OfferChat::setDeleted()
     * @see OfferChat::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildOfferChatQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OfferChatTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->offersScheduledForDeletion !== null) {
                if (!$this->offersScheduledForDeletion->isEmpty()) {
                    \OfferCreation\Model\OfferQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[OfferChatTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OfferChatTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(OfferChatTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(OfferChatTableMap::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'MESSAGE';
        }

        $sql = sprintf(
            'INSERT INTO offer_chat (%s) VALUES (%s)',
    ...
    {
        $pos = OfferChatTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OfferChat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OfferChat'][$this->getPrimaryKey()] = true;
        $keys = OfferChatTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(OfferChatTableMap::DATABASE_NAME);

        if ($this->isColumnModified(OfferChatTableMap::ID)) $criteria->add(OfferChatTableMap::ID, $this->id);
        if ($this->isColumnModified(OfferChatTableMap::MESSAGE)) $criteria->add(OfferChatTableMap::MESSAGE, $this->message);
    ...
    {
        $criteria = new Criteria(OfferChatTableMap::DATABASE_NAME);
        $criteria->add(OfferChatTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OfferCreation\Model\OfferChat (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \OfferCreation\Model\OfferChat Clone of current object.
     * @throws PropelException
     */
    ...
    public function initOffers($overrideExisting = true)
    {
        ...
        $this->collOffers->setModel('\OfferCreation\Model\Offer');
    }
     ...
     * If this ChildOfferChat is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return Collection|ChildOffer[] List of ChildOffer objects
     * @throws PropelException
     */
    public function getOffers($criteria = null, ConnectionInterface $con = null)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildOfferChat The current object (for fluent API support)
     */
    public function setOffers(Collection $offers, ConnectionInterface $con = null)
    {
        ...
        foreach ($offersToDelete as $offerRemoved) {
            $offerRemoved->setOfferChat(null);
        }
     ...
     * Otherwise if this OfferChat is new, it will return
     * an empty collection; or if this OfferChat has previously
     * been saved, it will retrieve related Offers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OfferChat.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinCurrency($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinCustomer($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinModuleRelatedByDeliveryModuleId($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinOrderAddressRelatedByDeliveryOrderAddressId($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinAdmin($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinOrderAddressRelatedByInvoiceOrderAddressId($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinLang($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinOrderRelatedByOrderId($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
        $query->joinWith('OrderRelatedByOrderId', $joinBehavior);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinOrderRelatedByOrderRef($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
        $query->joinWith('OrderRelatedByOrderRef', $joinBehavior);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinModuleRelatedByPaymentModuleId($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
     ...
     * @return Collection|ChildOffer[] List of ChildOffer objects
     */
    public function getOffersJoinOrderStatus($criteria = null, $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOfferQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(OfferChatTableMap::DEFAULT_STRING_FORMAT);
    }
