 ...
 */
class WartungspaketController extends BaseFrontController
{
    /**
    ...
    public function sendAction()
    {
        ...
        try {
            ...
            $message = \Swift_Message::newInstance("Wartungspaket Anfrage - :".$form->get('subject')->getData())
                ...
                ->setBody("Sie haben Wartungspaket Anfrage für Paket ".$form->get('subject')->getData(). " <br>Name:".$form->get('name')->getData()." <br>email:".$form->get('email')->getData()." <br>Anmerkung:".$form->get('message')->getData())
            ;
            ...
            return $this->generateRedirectFromRoute('wartungspaket.success');
