...
include_once  dirname(__FILE__).'/../Model/ListFinancialEventGroupsRequest.php';
  ...
  */
  ...
  function invokeListFinancialEventGroups(MWSFinancesService_Interface $service, $request)
  {
      try {
        ...
        $xml = $dom->saveXML();
        $listFinancialEventGroups = new SimpleXMLElement($xml);
        $array = json_encode($listFinancialEventGroups, TRUE);
