...
include_once dirname(__DIR__) . '/../MarketplaceWebService/Model/RequestReportRequest.php';
...
//sleep(1);
//$reportRequestId1 = invokeRequestReport($service, $request);
//sleep(1);
//$reportRequestId2 = invokeRequestReport($service, $request);
