...
class AmazonOrdersVersionTableMap extends TableMap
{
     ...
     */
    const CUSTOMER_ID_VERSION = 'amazon_orders_version.CUSTOMER_ID_VERSION';

    /**
     * the column name for the ORDER_ID_VERSION field
     */
    const ORDER_ID_VERSION = 'amazon_orders_version.ORDER_ID_VERSION';

    /**
     * the column name for the AMAZON_ORDER_PRODUCT_IDS field
     */
    const AMAZON_ORDER_PRODUCT_IDS = 'amazon_orders_version.AMAZON_ORDER_PRODUCT_IDS';

    /**
     * the column name for the AMAZON_ORDER_PRODUCT_VERSIONS field
     */
    const AMAZON_ORDER_PRODUCT_VERSIONS = 'amazon_orders_version.AMAZON_ORDER_PRODUCT_VERSIONS';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('AMAZON_ORDER_PRODUCT_IDS', 'AmazonOrderProductIds', 'ARRAY', false, null, null);
        $this->addColumn('AMAZON_ORDER_PRODUCT_VERSIONS', 'AmazonOrderProductVersions', 'ARRAY', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AmazonOrdersVersionTableMap::CUSTOMER_ID_VERSION);
            $criteria->addSelectColumn(AmazonOrdersVersionTableMap::ORDER_ID_VERSION);
            $criteria->addSelectColumn(AmazonOrdersVersionTableMap::AMAZON_ORDER_PRODUCT_IDS);
            $criteria->addSelectColumn(AmazonOrdersVersionTableMap::AMAZON_ORDER_PRODUCT_VERSIONS);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.AMAZON_ORDER_PRODUCT_IDS');
            $criteria->addSelectColumn($alias . '.AMAZON_ORDER_PRODUCT_VERSIONS');
        }
    }
