...
abstract class AmazonOrders implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AmazonIntegration\\Model\\Map\\AmazonOrdersTableMap';
    ...
    /**
     * Initializes internal state of AmazonIntegration\Model\Base\AmazonOrders object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \AmazonIntegration\Model\AmazonOrders object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->amazonOrdersVersionsScheduledForDeletion !== null) {
                if (!$this->amazonOrdersVersionsScheduledForDeletion->isEmpty()) {
                    \AmazonIntegration\Model\AmazonOrdersVersionQuery::create()
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AmazonIntegration\Model\AmazonOrders (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \AmazonIntegration\Model\AmazonOrders Clone of current object.
     * @throws PropelException
     */
    ...
    public function initAmazonOrdersVersions($overrideExisting = true)
    {
        ...
        $this->collAmazonOrdersVersions->setModel('\AmazonIntegration\Model\AmazonOrdersVersion');
    }
     ...
     *
     * @return \AmazonIntegration\Model\AmazonOrders
     */
     ...
     * @return PropelCollection|array \AmazonIntegration\Model\AmazonOrdersVersion[] List of \AmazonIntegration\Model\AmazonOrdersVersion objects
     */
