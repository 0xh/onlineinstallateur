...
abstract class SetProducts implements ActiveRecordInterface
{
    ...
    /**
     * The value for the number_of_products field.
     * @var        int
     */
    ...
    /**
     * Compares this with another <code>SetProducts</code> instance.  If
     * <code>obj</code> is an instance of <code>SetProducts</code>, delegates to
     * <code>equals(SetProducts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return SetProducts The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SetProductsTableMap::ID] = true;
        }
    ...
    public function setSetId($v)
    {
        ...
        if ($this->set_id !== $v) {
            $this->set_id = $v;
            $this->modifiedColumns[SetProductsTableMap::SET_ID] = true;
        }
    ...
    public function setNumberOfProducts($v)
    {
        ...
        if ($this->number_of_products !== $v) {
            $this->number_of_products = $v;
            $this->modifiedColumns[SetProductsTableMap::NUMBER_OF_PRODUCTS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SetProductsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SetProductsTableMap::translateFieldName('SetId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->set_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SetProductsTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSetProductsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SetProducts::setDeleted()
     * @see SetProducts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSetProductsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SetProductsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SetProductsTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(SetProductsTableMap::SET_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SET_ID';
        }
        if ($this->isColumnModified(SetProductsTableMap::PRODUCT_ID)) {
    ...
    {
        $pos = SetProductsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SetProducts'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SetProducts'][$this->getPrimaryKey()] = true;
        $keys = SetProductsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SetProductsTableMap::ID)) $criteria->add(SetProductsTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(SetProductsTableMap::DATABASE_NAME);
        $criteria->add(SetProductsTableMap::ID, $this->id);
    ...
    public function getSets(ConnectionInterface $con = null)
    {
        if ($this->aSets === null && ($this->set_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSets->addSetProductss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SetProductsTableMap::DEFAULT_STRING_FORMAT);
    }
