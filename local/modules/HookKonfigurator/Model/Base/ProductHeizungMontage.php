...
abstract class ProductHeizungMontage implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\HookKonfigurator\\Model\\Map\\ProductHeizungMontageTableMap';
    ...
    /**
     * The value for the product_heizung_id field.
     * @var        int
     */
    protected $product_heizung_id;
    ...
    /**
     * Initializes internal state of HookKonfigurator\Model\Base\ProductHeizungMontage object.
     */
    ...
    /**
     * Compares this with another <code>ProductHeizungMontage</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductHeizungMontage</code>, delegates to
     * <code>equals(ProductHeizungMontage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProductHeizungMontage The current object, for fluid interface
     */
    ...
    public function getProductHeizungId()
    {
        ...
        return $this->product_heizung_id;
    }
     ...
     * @return   \HookKonfigurator\Model\ProductHeizungMontage The current object (for fluent API support)
     */
    public function setProductHeizungId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->product_heizung_id !== $v) {
            $this->product_heizung_id = $v;
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductHeizungMontageTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductHeizungMontageTableMap::translateFieldName('ProductHeizungId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_heizung_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductHeizungMontageTableMap::translateFieldName('MontageId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProductHeizungMontageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \HookKonfigurator\Model\ProductHeizungMontage object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductHeizungMontageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProductHeizungMontage::setDeleted()
     * @see ProductHeizungMontage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProductHeizungMontageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductHeizungMontageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductHeizungMontageTableMap::PRODUCT_HEIZUNG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PRODUCT_HEIZUNG_ID';
        }
        if ($this->isColumnModified(ProductHeizungMontageTableMap::MONTAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'MONTAGE_ID';
        }

        $sql = sprintf(
            'INSERT INTO product_heizung_montage (%s) VALUES (%s)',
    ...
    {
        $pos = ProductHeizungMontageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getProductHeizungId();
                break;
            case 2:
    ...
    {
        if (isset($alreadyDumpedObjects['ProductHeizungMontage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductHeizungMontage'][$this->getPrimaryKey()] = true;
        $keys = ProductHeizungMontageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProductHeizungId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setProductHeizungId($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setProductHeizungId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductHeizungMontageTableMap::ID)) $criteria->add(ProductHeizungMontageTableMap::ID, $this->id);
        if ($this->isColumnModified(ProductHeizungMontageTableMap::PRODUCT_HEIZUNG_ID)) $criteria->add(ProductHeizungMontageTableMap::PRODUCT_HEIZUNG_ID, $this->product_heizung_id);
        if ($this->isColumnModified(ProductHeizungMontageTableMap::MONTAGE_ID)) $criteria->add(ProductHeizungMontageTableMap::MONTAGE_ID, $this->montage_id);
    ...
    {
        $criteria = new Criteria(ProductHeizungMontageTableMap::DATABASE_NAME);
        $criteria->add(ProductHeizungMontageTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \HookKonfigurator\Model\ProductHeizungMontage (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \HookKonfigurator\Model\ProductHeizungMontage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ProductHeizungMontageTableMap::DEFAULT_STRING_FORMAT);
    }
