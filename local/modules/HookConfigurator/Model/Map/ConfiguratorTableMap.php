...
class ConfiguratorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'HookConfigurator.Model.Map.ConfiguratorTableMap';
     ...
     */
    const OM_CLASS = '\\HookConfigurator\\Model\\Configurator';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'HookConfigurator.Model.Configurator';
     ...
     */
    const PARAMETERS = 'configurator.PARAMETERS';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Parameters', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'name', 'parameters', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ConfiguratorTableMap::ID, ConfiguratorTableMap::NAME, ConfiguratorTableMap::PARAMETERS, ConfiguratorTableMap::CREATED_AT, ConfiguratorTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'NAME', 'PARAMETERS', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'parameters', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Parameters' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'parameters' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(ConfiguratorTableMap::ID => 0, ConfiguratorTableMap::NAME => 1, ConfiguratorTableMap::PARAMETERS => 2, ConfiguratorTableMap::CREATED_AT => 3, ConfiguratorTableMap::UPDATED_AT => 4, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'NAME' => 1, 'PARAMETERS' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'parameters' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\HookConfigurator\\Model\\Configurator');
    ...
    {
        $this->addRelation('ConfiguratorHook', '\\HookConfigurator\\Model\\ConfiguratorHook', RelationMap::ONE_TO_MANY, array('id' => 'configurator_id', ), 'CASCADE', 'RESTRICT', 'ConfiguratorHooks');
        $this->addRelation('ConfiguratorElements', '\\HookConfigurator\\Model\\ConfiguratorElements', RelationMap::ONE_TO_MANY, array('id' => 'configurator_id', ), 'CASCADE', 'RESTRICT', 'ConfiguratorElementss');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfiguratorTableMap::NAME);
            $criteria->addSelectColumn(ConfiguratorTableMap::PARAMETERS);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \HookConfigurator\Model\Configurator) { // it's a model object
