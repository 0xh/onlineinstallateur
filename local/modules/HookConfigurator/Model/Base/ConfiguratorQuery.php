 ...
 * @method     ChildConfiguratorQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildConfiguratorQuery orderByParameters($order = Criteria::ASC) Order by the parameters column
 ...
 * @method     ChildConfiguratorQuery groupByName() Group by the name column
 * @method     ChildConfiguratorQuery groupByParameters() Group by the parameters column
 ...
 *
 * @method     ChildConfiguratorQuery leftJoinConfiguratorHook($relationAlias = null) Adds a LEFT JOIN clause to the query using the ConfiguratorHook relation
 * @method     ChildConfiguratorQuery rightJoinConfiguratorHook($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ConfiguratorHook relation
 * @method     ChildConfiguratorQuery innerJoinConfiguratorHook($relationAlias = null) Adds a INNER JOIN clause to the query using the ConfiguratorHook relation
 *
 * @method     ChildConfiguratorQuery leftJoinConfiguratorElements($relationAlias = null) Adds a LEFT JOIN clause to the query using the ConfiguratorElements relation
 * @method     ChildConfiguratorQuery rightJoinConfiguratorElements($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ConfiguratorElements relation
 * @method     ChildConfiguratorQuery innerJoinConfiguratorElements($relationAlias = null) Adds a INNER JOIN clause to the query using the ConfiguratorElements relation
 *
 ...
 * @method     ChildConfigurator findOneByName(string $name) Return the first ChildConfigurator filtered by the name column
 * @method     ChildConfigurator findOneByParameters(string $parameters) Return the first ChildConfigurator filtered by the parameters column
 ...
 * @method     array findByName(string $name) Return ChildConfigurator objects filtered by the name column
 * @method     array findByParameters(string $parameters) Return ChildConfigurator objects filtered by the parameters column
...
abstract class ConfiguratorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \HookConfigurator\Model\Base\ConfiguratorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\HookConfigurator\\Model\\Configurator', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \HookConfigurator\Model\ConfiguratorQuery) {
            return $criteria;
        }
        $query = new \HookConfigurator\Model\ConfiguratorQuery();
        if (null !== $modelAlias) {
    ...
    {
        $sql = 'SELECT ID, NAME, PARAMETERS, CREATED_AT, UPDATED_AT FROM configurator WHERE ID = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ConfiguratorTableMap::NAME, $name, $comparison);
    }
    ...
    public function filterByParameters($parameters = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ConfiguratorTableMap::PARAMETERS, $parameters, $comparison);
    }
    ...
    /**
     * Filter the query by a related \HookConfigurator\Model\ConfiguratorHook object
     *
     * @param \HookConfigurator\Model\ConfiguratorHook|ObjectCollection $configuratorHook  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildConfiguratorQuery The current query, for fluid interface
     */
    public function filterByConfiguratorHook($configuratorHook, $comparison = null)
    {
        if ($configuratorHook instanceof \HookConfigurator\Model\ConfiguratorHook) {
            return $this
                ->addUsingAlias(ConfiguratorTableMap::ID, $configuratorHook->getConfiguratorId(), $comparison);
        } elseif ($configuratorHook instanceof ObjectCollection) {
            return $this
                ->useConfiguratorHookQuery()
                ->filterByPrimaryKeys($configuratorHook->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByConfiguratorHook() only accepts arguments of type \HookConfigurator\Model\ConfiguratorHook or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the ConfiguratorHook relation
     *
     ...
     * @return ChildConfiguratorQuery The current query, for fluid interface
     */
    public function joinConfiguratorHook($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('ConfiguratorHook');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'ConfiguratorHook');
        }
    ...
    /**
     * Use the ConfiguratorHook relation ConfiguratorHook object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \HookConfigurator\Model\ConfiguratorHookQuery A secondary query class using the current class as primary query
     */
    public function useConfiguratorHookQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinConfiguratorHook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ConfiguratorHook', '\HookConfigurator\Model\ConfiguratorHookQuery');
    }

    /**
     * Filter the query by a related \HookConfigurator\Model\ConfiguratorElements object
     *
     * @param \HookConfigurator\Model\ConfiguratorElements|ObjectCollection $configuratorElements  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildConfiguratorQuery The current query, for fluid interface
     */
    public function filterByConfiguratorElements($configuratorElements, $comparison = null)
    {
        if ($configuratorElements instanceof \HookConfigurator\Model\ConfiguratorElements) {
            return $this
                ->addUsingAlias(ConfiguratorTableMap::ID, $configuratorElements->getConfiguratorId(), $comparison);
        } elseif ($configuratorElements instanceof ObjectCollection) {
            return $this
                ->useConfiguratorElementsQuery()
                ->filterByPrimaryKeys($configuratorElements->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByConfiguratorElements() only accepts arguments of type \HookConfigurator\Model\ConfiguratorElements or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the ConfiguratorElements relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return ChildConfiguratorQuery The current query, for fluid interface
     */
    public function joinConfiguratorElements($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('ConfiguratorElements');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'ConfiguratorElements');
        }
    ...
    /**
     * Use the ConfiguratorElements relation ConfiguratorElements object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \HookConfigurator\Model\ConfiguratorElementsQuery A secondary query class using the current class as primary query
     */
    public function useConfiguratorElementsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinConfiguratorElements($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ConfiguratorElements', '\HookConfigurator\Model\ConfiguratorElementsQuery');
    }
