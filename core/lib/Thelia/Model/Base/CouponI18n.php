...
abstract class CouponI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CouponI18nTableMap';
    ...
    /**
     * Compares this with another <code>CouponI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>CouponI18n</code>, delegates to
     * <code>equals(CouponI18n)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CouponI18n The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CouponI18nTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCouponI18nQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CouponI18n::setDeleted()
     * @see CouponI18n::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCouponI18nQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponI18nTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = CouponI18nTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CouponI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CouponI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = CouponI18nTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(CouponI18nTableMap::DATABASE_NAME);
        $criteria->add(CouponI18nTableMap::ID, $this->id);
        $criteria->add(CouponI18nTableMap::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\CouponI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\CouponI18n Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCoupon(ConnectionInterface $con = null)
    {
        if ($this->aCoupon === null && ($this->id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCoupon->addCouponI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponI18nTableMap::DEFAULT_STRING_FORMAT);
    }
