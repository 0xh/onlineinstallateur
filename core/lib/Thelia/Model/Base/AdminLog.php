...
abstract class AdminLog implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * The value for the admin_login field.
     * @var        string
     */
    protected $admin_login;

    /**
     * The value for the admin_firstname field.
     * @var        string
     */
    protected $admin_firstname;

    /**
     * The value for the admin_lastname field.
     * @var        string
     */
    ...
    /**
     * Compares this with another <code>AdminLog</code> instance.  If
     * <code>obj</code> is an instance of <code>AdminLog</code>, delegates to
     * <code>equals(AdminLog)</code>.  Otherwise, returns <code>false</code>.
     *
