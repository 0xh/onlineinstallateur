 ...
 * @method     ChildBrandQuery orderByVisible($order = Criteria::ASC) Order by the visible column
 * @method     ChildBrandQuery orderByPosition($order = Criteria::ASC) Order by the position column
 * @method     ChildBrandQuery orderByLogoImageId($order = Criteria::ASC) Order by the logo_image_id column
 * @method     ChildBrandQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildBrandQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     ChildBrandQuery groupById() Group by the id column
 * @method     ChildBrandQuery groupByVisible() Group by the visible column
 * @method     ChildBrandQuery groupByPosition() Group by the position column
 * @method     ChildBrandQuery groupByLogoImageId() Group by the logo_image_id column
 * @method     ChildBrandQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildBrandQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     ChildBrandQuery leftJoinBrandImageRelatedByLogoImageId($relationAlias = null) Adds a LEFT JOIN clause to the query using the BrandImageRelatedByLogoImageId relation
 * @method     ChildBrandQuery rightJoinBrandImageRelatedByLogoImageId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BrandImageRelatedByLogoImageId relation
 * @method     ChildBrandQuery innerJoinBrandImageRelatedByLogoImageId($relationAlias = null) Adds a INNER JOIN clause to the query using the BrandImageRelatedByLogoImageId relation
 *
 ...
 *
 * @method     ChildBrandQuery leftJoinBrandDocument($relationAlias = null) Adds a LEFT JOIN clause to the query using the BrandDocument relation
 * @method     ChildBrandQuery rightJoinBrandDocument($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BrandDocument relation
 * @method     ChildBrandQuery innerJoinBrandDocument($relationAlias = null) Adds a INNER JOIN clause to the query using the BrandDocument relation
 *
 * @method     ChildBrandQuery leftJoinBrandImageRelatedByBrandId($relationAlias = null) Adds a LEFT JOIN clause to the query using the BrandImageRelatedByBrandId relation
 * @method     ChildBrandQuery rightJoinBrandImageRelatedByBrandId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BrandImageRelatedByBrandId relation
 * @method     ChildBrandQuery innerJoinBrandImageRelatedByBrandId($relationAlias = null) Adds a INNER JOIN clause to the query using the BrandImageRelatedByBrandId relation
 *
 * @method     ChildBrandQuery leftJoinBrandI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the BrandI18n relation
 * @method     ChildBrandQuery rightJoinBrandI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BrandI18n relation
 * @method     ChildBrandQuery innerJoinBrandI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the BrandI18n relation
 *
 ...
 * @method     ChildBrand findOneByVisible(int $visible) Return the first ChildBrand filtered by the visible column
 * @method     ChildBrand findOneByPosition(int $position) Return the first ChildBrand filtered by the position column
 * @method     ChildBrand findOneByLogoImageId(int $logo_image_id) Return the first ChildBrand filtered by the logo_image_id column
 * @method     ChildBrand findOneByCreatedAt(string $created_at) Return the first ChildBrand filtered by the created_at column
 * @method     ChildBrand findOneByUpdatedAt(string $updated_at) Return the first ChildBrand filtered by the updated_at column
 *
 * @method     array findById(int $id) Return ChildBrand objects filtered by the id column
 * @method     array findByVisible(int $visible) Return ChildBrand objects filtered by the visible column
 * @method     array findByPosition(int $position) Return ChildBrand objects filtered by the position column
 * @method     array findByLogoImageId(int $logo_image_id) Return ChildBrand objects filtered by the logo_image_id column
 * @method     array findByCreatedAt(string $created_at) Return ChildBrand objects filtered by the created_at column
 * @method     array findByUpdatedAt(string $updated_at) Return ChildBrand objects filtered by the updated_at column
 *
 */
abstract class BrandQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'thelia', $modelName = '\\Thelia\\Model\\Brand', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Thelia\Model\BrandQuery) {
            return $criteria;
        }
        $query = new \Thelia\Model\BrandQuery();
        if (null !== $modelAlias) {
