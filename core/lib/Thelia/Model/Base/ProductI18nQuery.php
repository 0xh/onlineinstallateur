...
abstract class ProductI18nQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'thelia', $modelName = '\\Thelia\\Model\\ProductI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Thelia\Model\ProductI18nQuery) {
            return $criteria;
        }
        $query = new \Thelia\Model\ProductI18nQuery();
        if (null !== $modelAlias) {
