...
abstract class CategoryDocument implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CategoryDocumentTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildCategoryDocumentI18n[] Collection to store aggregation of ChildCategoryDocumentI18n objects.
     */
    protected $collCategoryDocumentI18ns;
    protected $collCategoryDocumentI18nsPartial;
     ...
     * @var        array[ChildCategoryDocumentI18n]
     */
     ...
     */
    protected $categoryDocumentI18nsScheduledForDeletion = null;
    ...
    /**
     * Compares this with another <code>CategoryDocument</code> instance.  If
     * <code>obj</code> is an instance of <code>CategoryDocument</code>, delegates to
     * <code>equals(CategoryDocument)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[CategoryDocumentTableMap::VISIBLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoryDocumentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoryDocumentTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryDocumentTableMap::translateFieldName('File', TableMap::TYPE_PHPNAME, $indexType)];
            $this->file = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoryDocumentTableMap::translateFieldName('Visible', TableMap::TYPE_PHPNAME, $indexType)];
            $this->visible = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoryDocumentTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategoryDocumentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategoryDocumentTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = CategoryDocumentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\CategoryDocument object", 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CategoryDocumentTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                CategoryDocumentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryDocumentTableMap::VISIBLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryDocumentTableMap::VISIBLE)) $criteria->add(CategoryDocumentTableMap::VISIBLE, $this->visible);
    ...
    public function getTranslation($locale = 'en_US', ConnectionInterface $con = null)
    {
        if (!isset($this->currentTranslations[$locale])) {
            if (null !== $this->collCategoryDocumentI18ns) {
                foreach ($this->collCategoryDocumentI18ns as $translation) {
            ...
            if ($this->isNew()) {
                $translation = new ChildCategoryDocumentI18n();
                $translation->setLocale($locale);
            } else {
                $translation = ChildCategoryDocumentI18nQuery::create()
