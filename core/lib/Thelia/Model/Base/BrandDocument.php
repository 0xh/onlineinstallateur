...
abstract class BrandDocument implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\BrandDocumentTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildBrandDocumentI18n[] Collection to store aggregation of ChildBrandDocumentI18n objects.
     */
    protected $collBrandDocumentI18ns;
    protected $collBrandDocumentI18nsPartial;
     ...
     * @var        array[ChildBrandDocumentI18n]
     */
     ...
     */
    protected $brandDocumentI18nsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\BrandDocument object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>BrandDocument</code> instance.  If
     * <code>obj</code> is an instance of <code>BrandDocument</code>, delegates to
     * <code>equals(BrandDocument)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[BrandDocumentTableMap::VISIBLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BrandDocumentTableMap::translateFieldName('Visible', TableMap::TYPE_PHPNAME, $indexType)];
            $this->visible = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BrandDocumentTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : BrandDocumentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : BrandDocumentTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = BrandDocumentTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BrandDocumentTableMap::VISIBLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BrandDocumentTableMap::VISIBLE)) $criteria->add(BrandDocumentTableMap::VISIBLE, $this->visible);
