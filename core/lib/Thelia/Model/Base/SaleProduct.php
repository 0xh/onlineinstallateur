...
abstract class SaleProduct implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\SaleProductTableMap';
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\SaleProduct object.
     */
    ...
    /**
     * Compares this with another <code>SaleProduct</code> instance.  If
     * <code>obj</code> is an instance of <code>SaleProduct</code>, delegates to
     * <code>equals(SaleProduct)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return SaleProduct The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SaleProductTableMap::ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[SaleProductTableMap::PRODUCT_ID] = true;
        }
    ...
    public function setAttributeAvId($v)
    {
        ...
        if ($this->attribute_av_id !== $v) {
            ...
            $this->modifiedColumns[SaleProductTableMap::ATTRIBUTE_AV_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SaleProductTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SaleProductTableMap::translateFieldName('SaleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sale_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SaleProductTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SaleProductTableMap::translateFieldName('AttributeAvId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SaleProductTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\SaleProduct object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSaleProductQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SaleProduct::setDeleted()
     * @see SaleProduct::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSaleProductQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SaleProductTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SaleProductTableMap::ID)) {
        ...
        if ($this->isColumnModified(SaleProductTableMap::ATTRIBUTE_AV_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ATTRIBUTE_AV_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `sale_product` (%s) VALUES (%s)',
    ...
    {
        $pos = SaleProductTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setSaleId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SaleProductTableMap::ID)) $criteria->add(SaleProductTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(SaleProductTableMap::DATABASE_NAME);
        $criteria->add(SaleProductTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\SaleProduct (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\SaleProduct Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSale(ConnectionInterface $con = null)
    {
        if ($this->aSale === null && ($this->sale_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSale->addSaleProducts($this);
             */
        }
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addSaleProducts($this);
             */
        }
    ...
    public function getAttributeAv(ConnectionInterface $con = null)
    {
        if ($this->aAttributeAv === null && ($this->attribute_av_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttributeAv->addSaleProducts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SaleProductTableMap::DEFAULT_STRING_FORMAT);
    }
