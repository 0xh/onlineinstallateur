...
abstract class CouponCustomerCount implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CouponCustomerCountTableMap';
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\CouponCustomerCount object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CouponCustomerCount</code> instance.  If
     * <code>obj</code> is an instance of <code>CouponCustomerCount</code>, delegates to
     * <code>equals(CouponCustomerCount)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CouponCustomerCount The current object, for fluid interface
     */
     ...
     * @return   \Thelia\Model\CouponCustomerCount The current object (for fluent API support)
     */
    public function setCouponId($v)
    {
        ...
        if ($this->coupon_id !== $v) {
            $this->coupon_id = $v;
            $this->modifiedColumns[CouponCustomerCountTableMap::COUPON_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[CouponCustomerCountTableMap::CUSTOMER_ID] = true;
        }
    ...
    public function setCount($v)
    {
        ...
        if ($this->count !== $v) {
            $this->count = $v;
            $this->modifiedColumns[CouponCustomerCountTableMap::COUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CouponCustomerCountTableMap::translateFieldName('CouponId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coupon_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CouponCustomerCountTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CouponCustomerCountTableMap::translateFieldName('Count', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CouponCustomerCountTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\CouponCustomerCount object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCouponCustomerCountQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCouponCustomerCountQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponCustomerCountTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CouponCustomerCountTableMap::COUPON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COUPON_ID`';
        }
        if ($this->isColumnModified(CouponCustomerCountTableMap::CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CUSTOMER_ID`';
        }
        if ($this->isColumnModified(CouponCustomerCountTableMap::COUNT)) {
            $modifiedColumns[':p' . $index++]  = '`COUNT`';
        }

        $sql = sprintf(
            'INSERT INTO `coupon_customer_count` (%s) VALUES (%s)',
    ...
    {
        $pos = CouponCustomerCountTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CouponCustomerCountTableMap::COUPON_ID)) $criteria->add(CouponCustomerCountTableMap::COUPON_ID, $this->coupon_id);
        if ($this->isColumnModified(CouponCustomerCountTableMap::CUSTOMER_ID)) $criteria->add(CouponCustomerCountTableMap::CUSTOMER_ID, $this->customer_id);
        if ($this->isColumnModified(CouponCustomerCountTableMap::COUNT)) $criteria->add(CouponCustomerCountTableMap::COUNT, $this->count);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\CouponCustomerCount (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\CouponCustomerCount Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && ($this->customer_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomer->addCouponCustomerCounts($this);
             */
        }
    ...
    public function getCoupon(ConnectionInterface $con = null)
    {
        if ($this->aCoupon === null && ($this->coupon_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCoupon->addCouponCustomerCounts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponCustomerCountTableMap::DEFAULT_STRING_FORMAT);
    }
