...
abstract class MessageI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\MessageI18nTableMap';
    ...
    /**
     * Compares this with another <code>MessageI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>MessageI18n</code>, delegates to
     * <code>equals(MessageI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MessageI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[MessageI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[MessageI18nTableMap::TITLE] = true;
        }
    ...
    public function setSubject($v)
    {
        ...
        if ($this->subject !== $v) {
            $this->subject = $v;
            $this->modifiedColumns[MessageI18nTableMap::SUBJECT] = true;
        }
    ...
    public function setTextMessage($v)
    {
        ...
        if ($this->text_message !== $v) {
            $this->text_message = $v;
            $this->modifiedColumns[MessageI18nTableMap::TEXT_MESSAGE] = true;
        }
    ...
    public function setHtmlMessage($v)
    {
        ...
        if ($this->html_message !== $v) {
            $this->html_message = $v;
            $this->modifiedColumns[MessageI18nTableMap::HTML_MESSAGE] = true;
        }
