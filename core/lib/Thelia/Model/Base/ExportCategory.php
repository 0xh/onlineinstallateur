...
abstract class ExportCategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\ExportCategoryTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildExport[] Collection to store aggregation of ChildExport objects.
     */
    protected $collExports;
    protected $collExportsPartial;

    /**
     * @var        ObjectCollection|ChildExportCategoryI18n[] Collection to store aggregation of ChildExportCategoryI18n objects.
     */
    protected $collExportCategoryI18ns;
    protected $collExportCategoryI18nsPartial;
     ...
     * @var        array[ChildExportCategoryI18n]
     */
     ...
     */
    protected $exportsScheduledForDeletion = null;

    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection
     */
    protected $exportCategoryI18nsScheduledForDeletion = null;

    /**
     * Initializes internal state of Thelia\Model\Base\ExportCategory object.
     */
    ...
    /**
     * Compares this with another <code>ExportCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>ExportCategory</code>, delegates to
     * <code>equals(ExportCategory)</code>.  Otherwise, returns <code>false</code>.
     *
