...
abstract class CategoryDocumentI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CategoryDocumentI18nTableMap';
    ...
    /**
     * Compares this with another <code>CategoryDocumentI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>CategoryDocumentI18n</code>, delegates to
     * <code>equals(CategoryDocumentI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::ID] = true;
        }

        if ($this->aCategoryDocument !== null && $this->aCategoryDocument->getId() !== $v) {
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::DESCRIPTION] = true;
        }
    ...
    public function setChapo($v)
    {
        ...
        if ($this->chapo !== $v) {
            $this->chapo = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::CHAPO] = true;
        }
    ...
    public function setPostscriptum($v)
    {
        ...
        if ($this->postscriptum !== $v) {
            $this->postscriptum = $v;
            $this->modifiedColumns[CategoryDocumentI18nTableMap::POSTSCRIPTUM] = true;
        }
    ...
    {
        return (string) $this->exportTo(CategoryDocumentI18nTableMap::DEFAULT_STRING_FORMAT);
    }
