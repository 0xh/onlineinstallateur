...
abstract class ProfileModule implements ActiveRecordInterface
{
    ...
    public function setProfileId($v)
    {
        ...
        if ($this->profile_id !== $v) {
            $this->profile_id = $v;
            $this->modifiedColumns[ProfileModuleTableMap::PROFILE_ID] = true;
        }
    ...
    public function setModuleId($v)
    {
        ...
        if ($this->module_id !== $v) {
            $this->module_id = $v;
            $this->modifiedColumns[ProfileModuleTableMap::MODULE_ID] = true;
        }
    ...
    public function setAccess($v)
    {
        ...
        if ($this->access !== $v) {
            $this->access = $v;
            $this->modifiedColumns[ProfileModuleTableMap::ACCESS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[ProfileModuleTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[ProfileModuleTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
