...
abstract class CouponModule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CouponModuleTableMap';
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\CouponModule object.
     */
    ...
    /**
     * Compares this with another <code>CouponModule</code> instance.  If
     * <code>obj</code> is an instance of <code>CouponModule</code>, delegates to
     * <code>equals(CouponModule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CouponModule The current object, for fluid interface
     */
     ...
     * @return   \Thelia\Model\CouponModule The current object (for fluent API support)
     */
    public function setCouponId($v)
    {
        ...
        if ($this->coupon_id !== $v) {
            $this->coupon_id = $v;
            $this->modifiedColumns[CouponModuleTableMap::COUPON_ID] = true;
        }
    ...
    public function setModuleId($v)
    {
        ...
        if ($this->module_id !== $v) {
            $this->module_id = $v;
            $this->modifiedColumns[CouponModuleTableMap::MODULE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CouponModuleTableMap::translateFieldName('CouponId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coupon_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CouponModuleTableMap::translateFieldName('ModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CouponModuleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\CouponModule object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCouponModuleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CouponModule::setDeleted()
     * @see CouponModule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCouponModuleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponModuleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CouponModuleTableMap::COUPON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COUPON_ID`';
        }
        if ($this->isColumnModified(CouponModuleTableMap::MODULE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`MODULE_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `coupon_module` (%s) VALUES (%s)',
    ...
    {
        $pos = CouponModuleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CouponModule'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CouponModule'][serialize($this->getPrimaryKey())] = true;
        $keys = CouponModuleTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CouponModuleTableMap::COUPON_ID)) $criteria->add(CouponModuleTableMap::COUPON_ID, $this->coupon_id);
        if ($this->isColumnModified(CouponModuleTableMap::MODULE_ID)) $criteria->add(CouponModuleTableMap::MODULE_ID, $this->module_id);
    ...
    {
        $criteria = new Criteria(CouponModuleTableMap::DATABASE_NAME);
        $criteria->add(CouponModuleTableMap::COUPON_ID, $this->coupon_id);
        $criteria->add(CouponModuleTableMap::MODULE_ID, $this->module_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\CouponModule (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\CouponModule Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCoupon(ConnectionInterface $con = null)
    {
        if ($this->aCoupon === null && ($this->coupon_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCoupon->addCouponModules($this);
             */
        }
    ...
    public function getModule(ConnectionInterface $con = null)
    {
        if ($this->aModule === null && ($this->module_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aModule->addCouponModules($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponModuleTableMap::DEFAULT_STRING_FORMAT);
    }
