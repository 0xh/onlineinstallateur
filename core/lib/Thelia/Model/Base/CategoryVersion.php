...
abstract class CategoryVersion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CategoryVersionTableMap';
    ...
    /**
     * Compares this with another <code>CategoryVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>CategoryVersion</code>, delegates to
     * <code>equals(CategoryVersion)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CategoryVersionTableMap::ID] = true;
        }
    ...
    public function setParent($v)
    {
        ...
        if ($this->parent !== $v) {
            $this->parent = $v;
            $this->modifiedColumns[CategoryVersionTableMap::PARENT] = true;
        }
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[CategoryVersionTableMap::VISIBLE] = true;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[CategoryVersionTableMap::POSITION] = true;
        }
    ...
    public function setDefaultTemplateId($v)
    {
        ...
        if ($this->default_template_id !== $v) {
            ...
            $this->modifiedColumns[CategoryVersionTableMap::DEFAULT_TEMPLATE_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[CategoryVersionTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[CategoryVersionTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[CategoryVersionTableMap::VERSION] = true;
        }
    ...
    public function setVersionCreatedAt($v)
    {
        ...
        if ($this->version_created_at !== null || $dt !== null) {
            if ($dt !== $this->version_created_at) {
                ...
                $this->modifiedColumns[CategoryVersionTableMap::VERSION_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[CategoryVersionTableMap::VERSION_CREATED_BY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoryVersionTableMap::translateFieldName('DefaultTemplateId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryVersionTableMap::DEFAULT_TEMPLATE_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryVersionTableMap::DEFAULT_TEMPLATE_ID)) $criteria->add(CategoryVersionTableMap::DEFAULT_TEMPLATE_ID, $this->default_template_id);
