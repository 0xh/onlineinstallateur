...
abstract class ResourceI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\ResourceI18nTableMap';
    ...
    /**
     * Compares this with another <code>ResourceI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>ResourceI18n</code>, delegates to
     * <code>equals(ResourceI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ResourceI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[ResourceI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ResourceI18nTableMap::TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ResourceI18nTableMap::DESCRIPTION] = true;
        }
    ...
    public function setChapo($v)
    {
        ...
        if ($this->chapo !== $v) {
            $this->chapo = $v;
            $this->modifiedColumns[ResourceI18nTableMap::CHAPO] = true;
        }
    ...
    public function setPostscriptum($v)
    {
        ...
        if ($this->postscriptum !== $v) {
            $this->postscriptum = $v;
            $this->modifiedColumns[ResourceI18nTableMap::POSTSCRIPTUM] = true;
        }
