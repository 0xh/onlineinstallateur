...
abstract class AttributeAvI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Compares this with another <code>AttributeAvI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>AttributeAvI18n</code>, delegates to
     * <code>equals(AttributeAvI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AttributeAvI18nTableMap::ID] = true;
        }
