...
abstract class ProductSaleElementsProductImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\ProductSaleElementsProductImageTableMap';
    ...
    /**
     * Compares this with another <code>ProductSaleElementsProductImage</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductSaleElementsProductImage</code>, delegates to
     * <code>equals(ProductSaleElementsProductImage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProductSaleElementsProductImage The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProductSaleElementsProductImageTableMap::ID] = true;
        }
    ...
    public function setProductSaleElementsId($v)
    {
        ...
        if ($this->product_sale_elements_id !== $v) {
            ...
            $this->modifiedColumns[ProductSaleElementsProductImageTableMap::PRODUCT_SALE_ELEMENTS_ID] = true;
        }
    ...
    public function setProductImageId($v)
    {
        ...
        if ($this->product_image_id !== $v) {
            ...
            $this->modifiedColumns[ProductSaleElementsProductImageTableMap::PRODUCT_IMAGE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductSaleElementsProductImageTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductSaleElementsProductImageTableMap::translateFieldName('ProductSaleElementsId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_sale_elements_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductSaleElementsProductImageTableMap::translateFieldName('ProductImageId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProductSaleElementsProductImageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\ProductSaleElementsProductImage object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductSaleElementsProductImageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProductSaleElementsProductImageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductSaleElementsProductImageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::PRODUCT_SALE_ELEMENTS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PRODUCT_SALE_ELEMENTS_ID`';
        }
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::PRODUCT_IMAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PRODUCT_IMAGE_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `product_sale_elements_product_image` (%s) VALUES (%s)',
    ...
    {
        $pos = ProductSaleElementsProductImageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductSaleElementsProductImage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductSaleElementsProductImage'][$this->getPrimaryKey()] = true;
        $keys = ProductSaleElementsProductImageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProductSaleElementsId(),
            $keys[2] => $this->getProductImageId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setProductImageId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::ID)) $criteria->add(ProductSaleElementsProductImageTableMap::ID, $this->id);
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::PRODUCT_SALE_ELEMENTS_ID)) $criteria->add(ProductSaleElementsProductImageTableMap::PRODUCT_SALE_ELEMENTS_ID, $this->product_sale_elements_id);
        if ($this->isColumnModified(ProductSaleElementsProductImageTableMap::PRODUCT_IMAGE_ID)) $criteria->add(ProductSaleElementsProductImageTableMap::PRODUCT_IMAGE_ID, $this->product_image_id);
    ...
    {
        $criteria = new Criteria(ProductSaleElementsProductImageTableMap::DATABASE_NAME);
        $criteria->add(ProductSaleElementsProductImageTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\ProductSaleElementsProductImage (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\ProductSaleElementsProductImage Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProductSaleElements(ConnectionInterface $con = null)
    {
        if ($this->aProductSaleElements === null && ($this->product_sale_elements_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProductSaleElements->addProductSaleElementsProductImages($this);
             */
        }
    ...
    public function getProductImage(ConnectionInterface $con = null)
    {
        if ($this->aProductImage === null && ($this->product_image_id !== null)) {
            $this->aProductImage = ChildProductImageQuery::create()->findPk($this->product_image_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductImage->addProductSaleElementsProductImages($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductSaleElementsProductImageTableMap::DEFAULT_STRING_FORMAT);
    }
