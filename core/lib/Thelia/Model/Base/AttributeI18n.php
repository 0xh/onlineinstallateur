...
abstract class AttributeI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Compares this with another <code>AttributeI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>AttributeI18n</code>, delegates to
     * <code>equals(AttributeI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AttributeI18nTableMap::ID] = true;
        }
