...
abstract class ModuleImageI18n implements ActiveRecordInterface
{
    ...
    /**
     * Compares this with another <code>ModuleImageI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>ModuleImageI18n</code>, delegates to
     * <code>equals(ModuleImageI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::DESCRIPTION] = true;
        }
    ...
    public function setChapo($v)
    {
        ...
        if ($this->chapo !== $v) {
            $this->chapo = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::CHAPO] = true;
        }
    ...
    public function setPostscriptum($v)
    {
        ...
        if ($this->postscriptum !== $v) {
            $this->postscriptum = $v;
            $this->modifiedColumns[ModuleImageI18nTableMap::POSTSCRIPTUM] = true;
        }
