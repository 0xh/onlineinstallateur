...
abstract class SaleOffsetCurrency implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\SaleOffsetCurrencyTableMap';
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\SaleOffsetCurrency object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SaleOffsetCurrency</code> instance.  If
     * <code>obj</code> is an instance of <code>SaleOffsetCurrency</code>, delegates to
     * <code>equals(SaleOffsetCurrency)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return SaleOffsetCurrency The current object, for fluid interface
     */
    ...
    /**
     * Get the [price_offset_value] column value.
     *
     * @return   double
     */
    public function getPriceOffsetValue()
    {

        return $this->price_offset_value;
    }
    ...
    public function setCurrencyId($v)
    {
        ...
        if ($this->currency_id !== $v) {
            $this->currency_id = $v;
            $this->modifiedColumns[SaleOffsetCurrencyTableMap::CURRENCY_ID] = true;
        }
    ...
    /**
     * Set the value of [price_offset_value] column.
     *
     * @param      double $v new value
     * @return   \Thelia\Model\SaleOffsetCurrency The current object (for fluent API support)
     */
    public function setPriceOffsetValue($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->price_offset_value !== $v) {
            $this->price_offset_value = $v;
            $this->modifiedColumns[SaleOffsetCurrencyTableMap::PRICE_OFFSET_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SaleOffsetCurrencyTableMap::translateFieldName('PriceOffsetValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_offset_value = (null !== $col) ? (double) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = SaleOffsetCurrencyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\SaleOffsetCurrency object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSaleOffsetCurrencyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SaleOffsetCurrency::setDeleted()
     * @see SaleOffsetCurrency::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildSaleOffsetCurrencyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SaleOffsetCurrencyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SaleOffsetCurrencyTableMap::PRICE_OFFSET_VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`PRICE_OFFSET_VALUE`';
        }

        $sql = sprintf(
            'INSERT INTO `sale_offset_currency` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`CURRENCY_ID`':
                        ...
                        break;
                    case '`PRICE_OFFSET_VALUE`':
                        $stmt->bindValue($identifier, $this->price_offset_value, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = SaleOffsetCurrencyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getPriceOffsetValue();
                break;
            default:
                return null;
                break;
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setPriceOffsetValue($value);
                break;
        } // switch()
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\SaleOffsetCurrency (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\SaleOffsetCurrency Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSale(ConnectionInterface $con = null)
    {
        if ($this->aSale === null && ($this->sale_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSale->addSaleOffsetCurrencies($this);
             */
        }
    ...
    public function getCurrency(ConnectionInterface $con = null)
    {
        if ($this->aCurrency === null && ($this->currency_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCurrency->addSaleOffsetCurrencies($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SaleOffsetCurrencyTableMap::DEFAULT_STRING_FORMAT);
    }
