 ...
 *
 *
 * @method     ChildModuleI18nQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildModuleI18nQuery orderByLocale($order = Criteria::ASC) Order by the locale column
 * @method     ChildModuleI18nQuery orderByTitle($order = Criteria::ASC) Order by the title column
 * @method     ChildModuleI18nQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildModuleI18nQuery orderByChapo($order = Criteria::ASC) Order by the chapo column
 * @method     ChildModuleI18nQuery orderByPostscriptum($order = Criteria::ASC) Order by the postscriptum column
 *
 * @method     ChildModuleI18nQuery groupById() Group by the id column
 * @method     ChildModuleI18nQuery groupByLocale() Group by the locale column
 * @method     ChildModuleI18nQuery groupByTitle() Group by the title column
 * @method     ChildModuleI18nQuery groupByDescription() Group by the description column
 * @method     ChildModuleI18nQuery groupByChapo() Group by the chapo column
 * @method     ChildModuleI18nQuery groupByPostscriptum() Group by the postscriptum column
 *
 * @method     ChildModuleI18nQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildModuleI18nQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildModuleI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildModuleI18nQuery leftJoinModule($relationAlias = null) Adds a LEFT JOIN clause to the query using the Module relation
 * @method     ChildModuleI18nQuery rightJoinModule($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Module relation
 * @method     ChildModuleI18nQuery innerJoinModule($relationAlias = null) Adds a INNER JOIN clause to the query using the Module relation
 *
 * @method     ChildModuleI18n findOne(ConnectionInterface $con = null) Return the first ChildModuleI18n matching the query
 * @method     ChildModuleI18n findOneOrCreate(ConnectionInterface $con = null) Return the first ChildModuleI18n matching the query, or a new ChildModuleI18n object populated from the query conditions when no match is found
 *
 * @method     ChildModuleI18n findOneById(int $id) Return the first ChildModuleI18n filtered by the id column
 * @method     ChildModuleI18n findOneByLocale(string $locale) Return the first ChildModuleI18n filtered by the locale column
 * @method     ChildModuleI18n findOneByTitle(string $title) Return the first ChildModuleI18n filtered by the title column
 * @method     ChildModuleI18n findOneByDescription(string $description) Return the first ChildModuleI18n filtered by the description column
 * @method     ChildModuleI18n findOneByChapo(string $chapo) Return the first ChildModuleI18n filtered by the chapo column
 * @method     ChildModuleI18n findOneByPostscriptum(string $postscriptum) Return the first ChildModuleI18n filtered by the postscriptum column
 *
 * @method     array findById(int $id) Return ChildModuleI18n objects filtered by the id column
 * @method     array findByLocale(string $locale) Return ChildModuleI18n objects filtered by the locale column
 * @method     array findByTitle(string $title) Return ChildModuleI18n objects filtered by the title column
 * @method     array findByDescription(string $description) Return ChildModuleI18n objects filtered by the description column
 * @method     array findByChapo(string $chapo) Return ChildModuleI18n objects filtered by the chapo column
 * @method     array findByPostscriptum(string $postscriptum) Return ChildModuleI18n objects filtered by the postscriptum column
 *
 */
abstract class ModuleI18nQuery extends ModelCriteria
{
     ...
     *
     * @return ChildModuleI18nQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof \Thelia\Model\ModuleI18nQuery) {
            return $criteria;
        }
        $query = new \Thelia\Model\ModuleI18nQuery();
        if (null !== $modelAlias) {
