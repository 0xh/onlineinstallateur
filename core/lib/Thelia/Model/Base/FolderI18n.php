...
abstract class FolderI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Compares this with another <code>FolderI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>FolderI18n</code>, delegates to
     * <code>equals(FolderI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[FolderI18nTableMap::ID] = true;
        }
