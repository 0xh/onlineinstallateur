...
abstract class ModuleImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\ModuleImageTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildModuleImageI18n[] Collection to store aggregation of ChildModuleImageI18n objects.
     */
    protected $collModuleImageI18ns;
    protected $collModuleImageI18nsPartial;
     ...
     * @var        array[ChildModuleImageI18n]
     */
     ...
     */
    protected $moduleImageI18nsScheduledForDeletion = null;
    ...
    /**
     * Compares this with another <code>ModuleImage</code> instance.  If
     * <code>obj</code> is an instance of <code>ModuleImage</code>, delegates to
     * <code>equals(ModuleImage)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ModuleImageTableMap::ID] = true;
        }
    ...
    public function setModuleId($v)
    {
        ...
        if ($this->module_id !== $v) {
            $this->module_id = $v;
            $this->modifiedColumns[ModuleImageTableMap::MODULE_ID] = true;
        }
    ...
    public function setFile($v)
    {
        ...
        if ($this->file !== $v) {
            $this->file = $v;
            $this->modifiedColumns[ModuleImageTableMap::FILE] = true;
        }
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[ModuleImageTableMap::VISIBLE] = true;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[ModuleImageTableMap::POSITION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[ModuleImageTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[ModuleImageTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ModuleImageTableMap::translateFieldName('Visible', TableMap::TYPE_PHPNAME, $indexType)];
            $this->visible = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ModuleImageTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ModuleImageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ModuleImageTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = ModuleImageTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ModuleImageTableMap::VISIBLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ModuleImageTableMap::VISIBLE)) $criteria->add(ModuleImageTableMap::VISIBLE, $this->visible);
