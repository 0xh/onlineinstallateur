...
abstract class TemplateI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\TemplateI18nTableMap';
    ...
    /**
     * Compares this with another <code>TemplateI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>TemplateI18n</code>, delegates to
     * <code>equals(TemplateI18n)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TemplateI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[TemplateI18nTableMap::LOCALE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TemplateI18nTableMap::NAME] = true;
        }
