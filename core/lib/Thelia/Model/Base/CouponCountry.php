...
abstract class CouponCountry implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\CouponCountryTableMap';
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\CouponCountry object.
     */
    ...
    /**
     * Compares this with another <code>CouponCountry</code> instance.  If
     * <code>obj</code> is an instance of <code>CouponCountry</code>, delegates to
     * <code>equals(CouponCountry)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CouponCountry The current object, for fluid interface
     */
     ...
     * @return   \Thelia\Model\CouponCountry The current object (for fluent API support)
     */
    public function setCouponId($v)
    {
        ...
        if ($this->coupon_id !== $v) {
            $this->coupon_id = $v;
            $this->modifiedColumns[CouponCountryTableMap::COUPON_ID] = true;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[CouponCountryTableMap::COUNTRY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CouponCountryTableMap::translateFieldName('CouponId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coupon_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CouponCountryTableMap::translateFieldName('CountryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CouponCountryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Thelia\Model\CouponCountry object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCouponCountryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CouponCountry::setDeleted()
     * @see CouponCountry::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCouponCountryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CouponCountryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CouponCountryTableMap::COUPON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COUPON_ID`';
        }
        if ($this->isColumnModified(CouponCountryTableMap::COUNTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COUNTRY_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `coupon_country` (%s) VALUES (%s)',
    ...
    {
        $pos = CouponCountryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CouponCountry'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CouponCountry'][serialize($this->getPrimaryKey())] = true;
        $keys = CouponCountryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CouponCountryTableMap::COUPON_ID)) $criteria->add(CouponCountryTableMap::COUPON_ID, $this->coupon_id);
        if ($this->isColumnModified(CouponCountryTableMap::COUNTRY_ID)) $criteria->add(CouponCountryTableMap::COUNTRY_ID, $this->country_id);
    ...
    {
        $criteria = new Criteria(CouponCountryTableMap::DATABASE_NAME);
        $criteria->add(CouponCountryTableMap::COUPON_ID, $this->coupon_id);
        $criteria->add(CouponCountryTableMap::COUNTRY_ID, $this->country_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Thelia\Model\CouponCountry (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Thelia\Model\CouponCountry Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCountry(ConnectionInterface $con = null)
    {
        if ($this->aCountry === null && ($this->country_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCountry->addCouponCountries($this);
             */
        }
    ...
    public function getCoupon(ConnectionInterface $con = null)
    {
        if ($this->aCoupon === null && ($this->coupon_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCoupon->addCouponCountries($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CouponCountryTableMap::DEFAULT_STRING_FORMAT);
    }
