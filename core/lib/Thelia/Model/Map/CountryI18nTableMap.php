...
class CountryI18nTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Thelia\\Model\\CountryI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.CountryI18n';
     ...
     */
    const LOCALE = 'country_i18n.LOCALE';
     ...
     */
    const DESCRIPTION = 'country_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'country_i18n.CHAPO';

    /**
     * the column name for the POSTSCRIPTUM field
     */
    const POSTSCRIPTUM = 'country_i18n.POSTSCRIPTUM';
