...
class ProductDocumentTableMap extends TableMap
{
     ...
     */
    const VISIBLE = 'product_document.VISIBLE';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ProductDocumentTableMap::ID, ProductDocumentTableMap::PRODUCT_ID, ProductDocumentTableMap::FILE, ProductDocumentTableMap::VISIBLE, ProductDocumentTableMap::POSITION, ProductDocumentTableMap::CREATED_AT, ProductDocumentTableMap::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ProductDocumentTableMap::ID => 0, ProductDocumentTableMap::PRODUCT_ID => 1, ProductDocumentTableMap::FILE => 2, ProductDocumentTableMap::VISIBLE => 3, ProductDocumentTableMap::POSITION => 4, ProductDocumentTableMap::CREATED_AT => 5, ProductDocumentTableMap::UPDATED_AT => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductDocumentTableMap::VISIBLE);
