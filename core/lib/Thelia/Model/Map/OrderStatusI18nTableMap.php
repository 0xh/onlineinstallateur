...
class OrderStatusI18nTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'order_status_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\OrderStatusI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.OrderStatusI18n';
     ...
     */
    const ID = 'order_status_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const LOCALE = 'order_status_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'order_status_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'order_status_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'order_status_i18n.CHAPO';

    /**
     * the column name for the POSTSCRIPTUM field
     */
    const POSTSCRIPTUM = 'order_status_i18n.POSTSCRIPTUM';
