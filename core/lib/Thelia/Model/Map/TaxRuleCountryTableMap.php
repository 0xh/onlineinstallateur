...
class TaxRuleCountryTableMap extends TableMap
{
     ...
     */
    const STATE_ID = 'tax_rule_country.STATE_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'TaxRuleId', 'CountryId', 'StateId', 'TaxId', 'Position', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'taxRuleId', 'countryId', 'stateId', 'taxId', 'position', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(TaxRuleCountryTableMap::ID, TaxRuleCountryTableMap::TAX_RULE_ID, TaxRuleCountryTableMap::COUNTRY_ID, TaxRuleCountryTableMap::STATE_ID, TaxRuleCountryTableMap::TAX_ID, TaxRuleCountryTableMap::POSITION, TaxRuleCountryTableMap::CREATED_AT, TaxRuleCountryTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TAX_RULE_ID', 'COUNTRY_ID', 'STATE_ID', 'TAX_ID', 'POSITION', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'tax_rule_id', 'country_id', 'state_id', 'tax_id', 'position', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'TaxRuleId' => 1, 'CountryId' => 2, 'StateId' => 3, 'TaxId' => 4, 'Position' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'taxRuleId' => 1, 'countryId' => 2, 'stateId' => 3, 'taxId' => 4, 'position' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(TaxRuleCountryTableMap::ID => 0, TaxRuleCountryTableMap::TAX_RULE_ID => 1, TaxRuleCountryTableMap::COUNTRY_ID => 2, TaxRuleCountryTableMap::STATE_ID => 3, TaxRuleCountryTableMap::TAX_ID => 4, TaxRuleCountryTableMap::POSITION => 5, TaxRuleCountryTableMap::CREATED_AT => 6, TaxRuleCountryTableMap::UPDATED_AT => 7, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TAX_RULE_ID' => 1, 'COUNTRY_ID' => 2, 'STATE_ID' => 3, 'TAX_ID' => 4, 'POSITION' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'tax_rule_id' => 1, 'country_id' => 2, 'state_id' => 3, 'tax_id' => 4, 'position' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('TAX_RULE_ID', 'TaxRuleId', 'INTEGER', 'tax_rule', 'ID', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TaxRuleCountryTableMap::STATE_ID);
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TaxRuleCountryTableMap::ID) && $criteria->keyContainsValue(TaxRuleCountryTableMap::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TaxRuleCountryTableMap::ID.')');
        }
