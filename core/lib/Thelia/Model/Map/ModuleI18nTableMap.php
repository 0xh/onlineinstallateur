 ...
 *
 */
class ModuleI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Thelia.Model.Map.ModuleI18nTableMap';
     ...
     */
    const TABLE_NAME = 'module_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\ModuleI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.ModuleI18n';
     ...
     */
    const ID = 'module_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const LOCALE = 'module_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'module_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'module_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'module_i18n.CHAPO';

    /**
     * the column name for the POSTSCRIPTUM field
     */
    const POSTSCRIPTUM = 'module_i18n.POSTSCRIPTUM';
