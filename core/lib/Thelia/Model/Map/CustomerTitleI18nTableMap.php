...
class CustomerTitleI18nTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'customer_title_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\CustomerTitleI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.CustomerTitleI18n';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Locale', 'Short', 'Long', ),
