...
class FolderImageTableMap extends TableMap
{
     ...
     */
    const VISIBLE = 'folder_image.VISIBLE';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FolderImageTableMap::ID, FolderImageTableMap::FOLDER_ID, FolderImageTableMap::FILE, FolderImageTableMap::VISIBLE, FolderImageTableMap::POSITION, FolderImageTableMap::CREATED_AT, FolderImageTableMap::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FolderImageTableMap::ID => 0, FolderImageTableMap::FOLDER_ID => 1, FolderImageTableMap::FILE => 2, FolderImageTableMap::VISIBLE => 3, FolderImageTableMap::POSITION => 4, FolderImageTableMap::CREATED_AT => 5, FolderImageTableMap::UPDATED_AT => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FolderImageTableMap::VISIBLE);
