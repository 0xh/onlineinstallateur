...
class ContentI18nTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Thelia\\Model\\ContentI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.ContentI18n';
     ...
     */
    const DESCRIPTION = 'content_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'content_i18n.CHAPO';
