...
/**
 * This class defines the structure of the 'attribute_av_i18n' table.
 *
 *
 *
 ...
 *
 */
class AttributeAvI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Thelia.Model.Map.AttributeAvI18nTableMap';
     ...
     */
    const TABLE_NAME = 'attribute_av_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\AttributeAvI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.AttributeAvI18n';
