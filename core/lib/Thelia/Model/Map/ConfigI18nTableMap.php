 ...
 *
 */
class ConfigI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Thelia.Model.Map.ConfigI18nTableMap';
     ...
     */
    const TABLE_NAME = 'config_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\ConfigI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.ConfigI18n';
     ...
     */
    const ID = 'config_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const LOCALE = 'config_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'config_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'config_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'config_i18n.CHAPO';

    /**
     * the column name for the POSTSCRIPTUM field
     */
    const POSTSCRIPTUM = 'config_i18n.POSTSCRIPTUM';
