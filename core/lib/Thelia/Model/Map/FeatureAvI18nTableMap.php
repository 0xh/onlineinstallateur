...
class FeatureAvI18nTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'feature_av_i18n';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Thelia\\Model\\FeatureAvI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.FeatureAvI18n';
     ...
     */
    const ID = 'feature_av_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const LOCALE = 'feature_av_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'feature_av_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'feature_av_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'feature_av_i18n.CHAPO';
