...
class CategoryI18nTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Thelia\\Model\\CategoryI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Thelia.Model.CategoryI18n';
     ...
     */
    const LOCALE = 'category_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'category_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'category_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'category_i18n.CHAPO';
